...
function reloadChat () {
        ...
        success: function(data)
        {
            ...
            if(json.Status == 200)
            {
                ...
                for(var i = 0; i < json.Data.length; i++)
                {
                    ...
                    html +='        <span class="w-100 d-block text-muted dess">' + json.Data[i].description;
   ...
   $(".header-notification-section .dess").map(function() {
...
<script>
    function addsection(val)
    {
		...
		html +='			<div><label> Sr No:' + num + ').<br><span for="section_name'+ num +'">Section Name</span></label>';
		html +='			<input type="text" name="section[' + num + ']" id="section_name'+ num +'" value="" class="form-control tab-curriculum" required></div>';
    ...
    function addsubsection(e)
    {
        ...
        if($(e).attr('subtype') =='lesson')
        {
    		...
    		html +='        <label for="section_lesson_type' + $(e).attr('mastervalue') + '_' + num + '" >Lesson Type</label>';
    		html +='        <select class="form-control tab-curriculum" name="section_lesson_type[' + $(e).attr('mastervalue') + '][' + num + ']" id="section_lesson_type' + $(e).attr('mastervalue') + '_' + num + '" onchange="addlessoncontent(this)" mastervalue="' + $(e).attr('mastervalue') + '" subid="' + num + '">';
    		...
    		html +='        <label for=section_lesson_title' + $(e).attr('mastervalue') + '_' + num + '" ">Lesson Title</label>';
    		html +='        <input type="text" class="form-control subcat-form-control tab-curriculum" name="section_lesson_title[' + $(e).attr('mastervalue') + '][' + num + ']" id=section_lesson_title' + $(e).attr('mastervalue') + '_' + num + '" placeholder="enter lesson name">';
    		html +='    </div>';
    		html +='    <div class="col-xl-12">';
        ...
        if($(e).attr('subtype') =='quiz')
        {
        	...
        	html +='    </div>';
        	html +='    <div class="col-xl-12 form-group">';
        	html +='    	<label for="section_quiz_title' + $(e).attr('mastervalue') + '_' + num + '">Quiz Name</label>';
        	html +='    	<input class="form-control subcat-form-control  tab-curriculum" name="section_quiz_title[' + $(e).attr('mastervalue') + '][' + num + ']" id="section_quiz_title' + $(e).attr('mastervalue') + '_' + num + '" onchange="addlessoncontent(this)" mastervalue="' + $(e).attr('mastervalue') + '" subid="' + num + '">';
        	html +='    </div>';
        	html +='    <div class="col-xl-12 form-group">';
        	html +='    	<label for="section_quiz_instruction' + $(e).attr('mastervalue') + '_' + num + '">Quiz Instruction</label>';
        	html +='    	<textarea class="form-control  tab-curriculum" id="section_quiz_instruction' + $(e).attr('mastervalue') + '_' + num + '" name="section_quiz_instruction[' + $(e).attr('mastervalue') + '][' + num + ']"></textarea>';
        	html +='    </div>';
            ...
            html +='         		<div><label for="question_name' + $(e).attr('mastervalue') + '_' + num + '_1">Enter Question</label>';
            html +='         		<input type="text" class="tab-curriculum form-control" id="question_name' + $(e).attr('mastervalue') + '_' + num + '_1" name="question_name[' + $(e).attr('mastervalue') + '][' + num + '][1]" class="form-control" placeholder="enter question name"></div>';
            ...
            html +='    		        	<label for="question_option' + $(e).attr('mastervalue') + '_' + num + '_1_1">Option 1</label>';
            html +='    		        	<input type="text" id="question_option' + $(e).attr('mastervalue') + '_' + num + '_1_1" name="question_option[' + $(e).attr('mastervalue') + '][' + num + '][1][1]" class="form-control  tab-curriculum" placeholder="enter question name">';
            html +='    		        </div>';
            ...
            html +='		            </div>';
            html +='    		        <div class="col-xl-8 form-group">';
            html +='    		            <label  for="question_option' + $(e).attr('mastervalue') + '_' + num + '_1_2">Option 2</label>';
            html +='    		            <input type="text" name="question_option[' + $(e).attr('mastervalue') + '][' + num + '][1][2]" class="form-control  tab-curriculum"  id="question_option' + $(e).attr('mastervalue') + '_' + num + '_1_2" placeholder="enter question name">';
            html +='    		        </div>';
            html +='                    <div class="col-xl-2"></div>';
            html +='         		</div>';
    ...
    function addlessoncontent(e)
    {
        if($(e).val().length>0)
        {
            ...
            if(name == 'youtube' || name == 'vimeo')
            {
                ...
                html +='    <label  for="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_video_url">Video url( For web application )*</label>';
                html +='    <input type="text" class="form-control   tab-curriculum"  id="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_video_url" name="lesson_form[' + $(e).attr('mastervalue') + '][' + $(e).attr('subid') + '][video_url]">';
                html +='</div>';
                
                html +='<div class="col-xl-6 form-group">';
                html +='    <label  for="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_duration">Duration( For web application )*</label>';
                html +='    <input type="text" class="form-control   tab-curriculum" id="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_duration" name="lesson_form[' + $(e).attr('mastervalue') + '][' + $(e).attr('subid') + '][duration]" data-toggle="timepicker" data-minute-step="5" data-show-meridian="false" value="00:00:00">';
                html +='</div>';
                
                html +='<div class="col-xl-6 form-group">';
                html +='    <label  for="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_lesson_provider_for_mobile_application">Lesson provider( For mobile application )*</label>';
                html +='    <input type="text" class="form-control   tab-curriculum" id="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_lesson_provider_for_mobile_application" name="lesson_form[' + $(e).attr('mastervalue') + '][' + $(e).attr('subid') + '][lesson_provider_for_mobile_application]">';
                html +='</div>';
                
                html +='<div class="col-xl-6 form-group">';
                html +='    <label  for="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_html5_video_url_for_mobile_application">Video url( For mobile application )*</label>';
                html +='    <input type="text" class="form-control   tab-curriculum" id="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_html5_video_url_for_mobile_application" name="lesson_form[' + $(e).attr('mastervalue') + '][' + $(e).attr('subid') + '][html5_video_url_for_mobile_application]">';
                html +='</div>';
                
                html +='<div class="col-xl-6 form-group">';
                html +='    <label for="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_html5_duration_for_mobile_application">Duration( For mobile application )*</label>';
                html +='    <input type="text" class="form-control   tab-curriculum" id="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_html5_duration_for_mobile_application" name="lesson_form[' + $(e).attr('mastervalue') + '][' + $(e).attr('subid') + '][html5_duration_for_mobile_application]" data-toggle="timepicker" data-minute-step="5" data-show-meridian="false" value="00:00:00">';
                html +='</div>';
            ...
            {
                html +='<div class="col-xl-6 form-group">';
                html +='    <label  for="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_system_video_file">Upload system video file( For web and mobile application )*</label>';
                html +='    <input type="file" class="form-control   tab-curriculum" id="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_system_video_file" name="lesson_form[' + $(e).attr('mastervalue') + '][' + $(e).attr('subid') + '][system_video_file]">';
                ...
                html +='<div class="col-xl-6 form-group">';
                html +='    <label  for="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_system_video_file_duration">Duration( For web and mobile application )*</label>';
                html +='    <input type="text" class="form-control   tab-curriculum" id="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_system_video_file_duration" name="lesson_form[' + $(e).attr('mastervalue') + '][' + $(e).attr('subid') + '][system_video_file_duration]" data-toggle="timepicker" data-minute-step="5" data-show-meridian="false" value="00:00:00">';
                html +='</div>';
            }
            if(name == 'html5')
            {
                html +='<div class="col-xl-6 form-group">';
                html +='    <label  for="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_html5_video_url">Video url( For web application )*</label>';
                html +='    <input type="text" class="form-control   tab-curriculum" id="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_html5_video_url" name="lesson_form[' + $(e).attr('mastervalue') + '][' + $(e).attr('subid') + '][html5_video_url]">';
                html +='</div>';
                
                html +='<div class="col-xl-6 form-group">';
                html +='    <label  for="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_html5_duration">Duration( For web application )*</label>';
                html +='    <input type="text" class="form-control   tab-curriculum" id="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_html5_duration" name="lesson_form[' + $(e).attr('mastervalue') + '][' + $(e).attr('subid') + '][html5_duration]" data-toggle="timepicker" data-minute-step="5" data-show-meridian="false" value="00:00:00">';
                html +='</div>';
                
                html +='<div class="col-xl-6 form-group">';
                html +='    <label for="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_thumbnail">Thumbnail (The image size should be: 979 x 551)*</label>';
                html +='    <input type="file" class="form-control   tab-curriculum" id="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_thumbnail" name="lesson_form[' + $(e).attr('mastervalue') + '][' + $(e).attr('subid') + '][thumbnail]">';
                html +='</div>';
            }
            if(name == 'document' || name == 'image')
            {
                ...
                {
                    html +='<div class="col-xl-6 form-group">';
                    html +='    <label for="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_lesson_type">Video url( For web application )*</label>';
                    html +='    <select class="form-control   tab-curriculum" id="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_lesson_type" name="lesson_form[' + $(e).attr('mastervalue') + '][' + $(e).attr('subid') + '][lesson_type]">';
                ...
                html +='<div class="col-xl-6 form-group">';
                html +='    <label  for="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_attachment">Attachment</label>';
                html +='    <input type="file" class="form-control   tab-curriculum" id="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_attachment" name="lesson_form[' + $(e).attr('mastervalue') + '][' + $(e).attr('subid') + '][attachment]">';
                html +='</div>';
            }
            if(name == 'iframe')
            {
                html +='<div class="col-xl-6 form-group">';
                html +='    <label  for="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_iframe_source">Iframe source( Provide the source only )*</label>';
                html +='    <input type="text" class="form-control   tab-curriculum" id="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_iframe_source" name="lesson_form[' + $(e).attr('mastervalue') + '][' + $(e).attr('subid') + '][iframe_source]">';
                html +='</div>';
            }
            
            html +='<div class="col-xl-6 form-group">';
            html +='    <label for="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_summary" >Summary*</label>';
            html +='    <textarea class="form-control   tab-curriculum" id="lesson_form'+$(e).attr('mastervalue')+'_'+$(e).attr('subid')+'_summary" name="lesson_form[' + $(e).attr('mastervalue') + '][' + $(e).attr('subid') + '][summary]"></textarea>';
            html +='</div>';
    ...
    function addquestion(e)
    {
        ...
        html +='    <div><label  for="question_name' + $(e).attr('mastervalue') + '_' +  $(e).attr('quizvalue') +  '_' + num + '">Enter Question</label>';
        html +='    <input type="text" name="question_name[' + $(e).attr('mastervalue') + '][' + $(e).attr('quizvalue') + '][' + num + ']"  id="question_name' + $(e).attr('mastervalue') + '_' +  $(e).attr('quizvalue') +  '_' + num + '" placeholder="enter question name" class="form-control  tab-curriculum"></div>';
        ...
        html +='        </div>';
        html +='        <div class="col-xl-8 form-group">';
        html +='            <label for="question_option' + $(e).attr('mastervalue') + '_' + $(e).attr('quizvalue') + '_' + num + '_1">Option 1</label>';
        html +='            <input type="text" name="question_option[' + $(e).attr('mastervalue') + '][' + $(e).attr('quizvalue') + '][' + num + '][1]" id="question_option' + $(e).attr('mastervalue') + '_' + $(e).attr('quizvalue') + '_' + num + '_1" placeholder="enter question name" class="form-control  tab-curriculum">';
        html +='        </div>';
        html +='        <div class="col-xl-2"></div>';
        html +='        <div class="col-xl-2" style="display: flex;justify-content: center;align-items: center;">';
        html +='            <label>';
        ...
        html +='        </div>';
        html +='        <div class="col-xl-8 form-group">';
        html +='            <label for="question_option' + $(e).attr('mastervalue') + '_' + $(e).attr('quizvalue') + '_' + num + '_2">Option 2</label>';
        html +='            <input type="text" name="question_option[' + $(e).attr('mastervalue') + '][' + $(e).attr('quizvalue') + '][' + num + '][2]" id="question_option' + $(e).attr('mastervalue') + '_' + $(e).attr('quizvalue') + '_' + num + '_2" placeholder="enter question name" class="form-control  tab-curriculum">';
        html +='        </div>';
        html +='        <div class="col-xl-2"></div>';
        html +='    </div>';
    ...
    function addoption(e)
    {
        ...
        html +='    		            <label for="question_option' + $(e).attr('mastervalue') + '_' + $(e).attr('quizvalue') + '_' +  $(e).attr('quesvalue') + '_' + num + '">Option ' + num + '</label>';
        html +='    		            <input type="text" name="question_option[' + $(e).attr('mastervalue') + '][' + $(e).attr('quizvalue') + '][' + $(e).attr('quesvalue') + '][' + num + ']" class="form-control tab-curriculum " id="question_option' + $(e).attr('mastervalue') + '_' + $(e).attr('quizvalue') + '_' +  $(e).attr('quesvalue') + '_' + num + '" placeholder="enter question name">';
        html +='    		        </div>';
