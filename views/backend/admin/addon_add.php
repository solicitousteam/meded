<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> 
                <!--<i class="mdi mdi-webpack title_icon"></i> -->
                <img src="<?= base_url()?>uploads/plus.png" style="height: 34px; width: 30px;"alt="user-image">
                <?php echo "&nbsp;&nbsp;&nbsp;". get_phrase('add_new_addon'); ?>
                  <a href="<?php echo site_url('admin/addon'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"><?php echo get_phrase('go_to_addon_list'); ?></a>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
