<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> 
                  <!--<img src="https://ai24x7.com/uploads/flag.png" style="height: 44px; width: 44px;"alt="user-image">-->
...
<div class="row">
    <div class="col-12">
        <img src="<?=base_url(); ?>uploads/course_img.jpg">
    </div>
</div>
<div class="row">
    <div class="col-12">
        <div class="card widget-inline">
            <div class="card-body p-0">
                <div class="row no-gutters">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <a href="<?php echo site_url('admin/pending_courses'); ?>" class="text-secondary">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="col-xl-2">
                    ...
                    <button type="submit" class="btn btn-primary btn-block btn-rounded " name="button"><?php echo get_phrase('filter'); ?></button>
                </div>
            </form>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <small class="text-muted"><?php echo '<b>'.get_phrase('total_enrollment').'</b>: '.$enroll_history->num_rows(); ?></small>
                                    </td>
                                    ...
                                    <td>
                                        <div class="dropright dropright">
                                          ...
                                          <ul class="dropdown-menu">
                                                                                            <li><a class="dropdown-item" href="<?php echo site_url('admin/start_live_class/'.$course['id']); ?>" target="_blank">Start Live Class</a></li>

                                              <li><a class="dropdown-item" href="<?php echo site_url('home/course/'.slugify($course['title']).'/'.$course['id']); ?>" target="_blank">Preview</a></li>
