    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <form class="required-form" action="<?php echo site_url('admin/webinar/add'); ?>"
                                ...
                                <div class="tab-content b-0 mb-0">
                                    ...
                                    <div class="tab-pane" id="webinar-detail">
                                        <div class="row justify-content-center">
                                            <div class="col-xl-10">
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="agenda">Webinar Title<span class="required">*</span></label>
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            <label for="title"><?php echo get_phrase('title'); ?><span class="required">*</span></label>
                                                            <input type="text" name="title" id="title" class="form-control tab-4" value="" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            <label for="pain_point"><?php echo get_phrase("What's the agenda of your webinar? What tangible benifit(s) will your listener revice"); ?><span class="required">*</span></label>
                                                            <textarea rows="5" name="pain_point" id="pain_point" class="form-control tab-4" required></textarea>
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            <label for="cta"><?php echo get_phrase('End Goal or Final Call To Action (CTA)'); ?><span class="required">*</span></label>
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea rows="5" name="anything_else" id="anything_else" class="form-control tab-4" placeholder="" required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                       <div class="form-group">
                                                        ...
                                                        <!--    <input type="text" name="end_date" id="end_date" class="form-control tab-2 date" required data-toggle="date-picker" data-min-date="<?= date('m/d/Y');?>" value="<?= date('m/d/Y');?>" data-single-date-picker="true">-->
                                                        <!--</div>-->
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="proposed_time" id="proposed_time"
                                                                class="form-control tab-2" data-toggle="timepicker" value="00:00:00"  required placeholder="00:00:00" />
                                                        </div>
                                    ...
                                    <div class="tab-pane" id="media">
                                        <div class="row justify-content-center">
                                            <div class="col-xl-10">
                                                            ...
                                                            <div class="flex-grow-1 px-3">
                                                                <div class="form-group">
                                                                    <input type="file" name="thumbnail" id="thumbnail"
                                                                        class="form-control tab-5" accept="image/*" value="" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2" for="videoattachement"><?php echo get_phrase('Upload your presentation material'); ?><span class="required">*</span></label>
                                                    <div class="col-md-10" id="video_area">
                                                        <div class="d-flex mt-2">
                                                            <div class="flex-grow-1 px-3">
                                                                <div class="form-group">
                                                                    <input type="file" name="attachement[]" id="videoattachement"class="form-control tab-5" value="" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="number" class="form-control price_change tab-3"
                                                                name="discounted_price" id="discounted_price" required value="<?php echo $course_details['discounted_price'] ?? 0 ?>"
                                                                min="0" disabled oninput="course_amount_validation('discounted_price')">
                                                            <small
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-8">
                                                        <div class="what-you-get-box">
                                                            ...
                                                            <div class="what-you-get-title">
                                                                <?php echo site_phrase('Other Benefits'); ?>
                                                            </div>
