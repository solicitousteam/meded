                ...
                <div class="row">
                    <div class="col-xl-12">
                        <form class="required-form" id="course_add"
                            action="<?php echo site_url('admin/course_actions/add'); ?>" method="post"
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-xl-10">
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control tab-1 sd" id="course_title"
                                                            name="title"
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea name="short_description" id="short_description"
                                                            class="form-control tab-1 sd" required></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label"
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <select class="form-control select2 tab-1   sd" data-toggle="select2"
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control tab-1 date " id="proposed_date" name="proposed_date" placeholder="<?php echo get_phrase('enter_course_title'); ?>"
                                                            required data-toggle="date-picker" data-min-date="<?= date('d/m/Y');?>" data-single-date-picker="true" value="<?= date('d/m/Y');?>">
                                                        ...
                                                        <div id="requirement_area">
                                                            <div class="d-flex mt-2">
                                                                <div class="flex-grow-1 px-3">
                                                                    <div class="form-group">
                                                                        <input type="text" class="form-control tab-2 sd"
                                                            ...
                                                            <div id="blank_requirement_field">
                                                                <div class="d-flex mt-2">
                                                                    <div class="flex-grow-1 px-3">
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control sd"
                                                                                name="requirements[]" id="requirements"
                                                                                placeholder="<?php echo get_phrase('provide_Eligibility'); ?>">
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div class="col-md-10">
                                                        <div id="objective_area">
                                                            <div class="d-flex mt-2">
                                                                <div class="flex-grow-1 px-3">
                                                                    <div class="form-group">
                                                                        <input type="text" class="form-control tab-3 sd"
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-xl-10">
                                                <div class="form-group row mb-3">
                                                    <div class="offset-md-2 col-md-10">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input sd"
                                                                name="is_free_course" id="is_free_course" value="1" onclick="check_checkbox('price')">
                                                            <label class="custom-control-label"
                                                ...
                                                <div class="paid-course-stuffs">
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="number" class="form-control tab-4 amount-input sd" id="price" name="price" value="0" required
                                                                placeholder="<?php echo get_phrase('enter_course_price'); ?>" min="0" oninput="course_amount_valid('price')">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        <div class="offset-md-2 col-md-10">
                                                            <div class="custom-control custom-checkbox">
                                                                ...
                                                                onclick="check_checkbox('discounted_price')">
                                                                <label class="custom-control-label"
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="number" class="form-control tab-4 amount-input sd"
                                                                name="discounted_price" id="discounted_price"
                                                                min="0" value="0" disabled oninput="course_amount_valid('discounted_price')">
                                                            <small class="text-muted"><?php echo get_phrase('this_course_has'); ?>
                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-xl-10">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <select class="form-control select2 tab-5 sd" data-toggle="select2"
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <div id="course_overview_url-div">
                                                            <input type="url" class="form-control sd tab-5"
                                            ...
                                            <div class="col-xl-10 video_courtesy-div">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control tab-5 sd" name="video_courtesy"
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-xl-10">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control bootstrap-tag-input  sd"
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea  name="meta_description"
                                                            class="form-control sd"></textarea>
                                                    </div>
                                                </div>
                                            </div> <!-- end col -->
                                        </div> <!-- end row -->
