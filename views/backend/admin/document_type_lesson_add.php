<div class="form-group">
    <label for="document_type"><?php echo get_phrase('document_type'); ?><span class="required">*</span></label>
...
<div class="form-group">
    ...
    <div class="input-group">
        <div class="custom-file">
            <input type="file" class="custom-file-input" id="attachment" required name="attachment" onchange="changeTitleOfImageUploader(this)">
            <label class="custom-file-label" for="attachment"><?php echo get_phrase('attachment'); ?><span class="required">*</span></label>
        </div>
    </div>
</div>
