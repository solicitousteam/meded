	...
	<div class="col-md-12 col-md-offset-2">
        <div class="panel panel-primary" data-collapsed="0">
            <div class="panel-body">
              ...
              <table class="table table-bordered table table-striped table-centered mb-0" id="table-2" >
                  <thead>
                      <tr style="background:#2d368e">
                          <th style="color:white;"><?php echo get_phrase('title'); ?></th>
                          <th style="color:white;"><?php echo get_phrase('category'); ?></th>
                          <th style="color:white;"><?php echo get_phrase('sub_category'); ?></th>
                          <th style="color:white;"><?php echo get_phrase('instructor'); ?></th>
                          <th style="color:white;"><?php echo get_phrase('number_of_sections'); ?></th>
                          <th style="color:white;"><?php echo get_phrase('number_of_lessons'); ?></th>
                          <th style="color:white;"><?php echo get_phrase('number_of_enrolled_users'); ?></th>
                          <th style="color:white;"><?php echo get_phrase('action'); ?></th>
                      </tr>
                  </thead>
                  <tbody>
                      <?php
                                      ...
                                      <ul class="dropdown-menu">
                                          ...
                                          <li>
                                              <?php if ($course['user_id'] != $this->session->userdata('user_id')): ?>
                                                  <a href="#" onclick="confirm_modal('<?php echo base_url();?>admin/change_course_status_for_admin/active/<?php echo $course['id'];?>');">
