<div class="row ">
  <div class="col-xl-12">
    <div class="card">
      <div class="card-body">
        <h4 class="page-title"> 
        <!--<i class="mdi mdi-power-plug title_icon"></i>-->
        	<img src="<?= base_url()?>uploads/settings (3).png" style="height: 34px; width: 30px;"alt="user-image">
        <?php echo "&nbsp;&nbsp;&nbsp;".  get_phrase('addon_manager'); ?>
          <a href="<?php echo site_url('admin/addon/add'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"><i class="mdi mdi-plus"></i><?php echo get_phrase('add_new_addon'); ?></a>
        </h4>
      </div> <!-- end card body-->
    </div> <!-- end card -->
  </div><!-- end col-->
