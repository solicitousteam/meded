...
<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> 
                 <img src="<?= base_url('uploads/payment.png')?>" style="height: 44px; width: 44px;"alt="user-image"> 
                <!--<i class="mdi mdi-apple-keyboard-command title_icon"></i> -->
                <?php echo "&nbsp;&nbsp;&nbsp;". get_phrase('Setup_payment_informations'); ?></h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
</div>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group">
                    <label><?php echo get_phrase('secret_key').' ('.get_phrase('sandbox').')'; ?></label>
                    <?php if (isset($paypal[0]->sandbox_secret_key)): ?>
                        <input type="text" name="sandbox_secret_key" class="form-control" value="<?php echo $paypal[0]->sandbox_secret_key;?>" required />
                    <?php else: ?>
                        <input type="text" name="sandbox_secret_key" class="form-control" placeholder="<?php echo get_phrase('no_secret_key_found'); ?>" required />
                    <?php endif; ?>
                </div>
                ...
                <div class="form-group">
                    ...
                    <?php if (isset($paypal[0]->production_secret_key)): ?>
                        <input type="text" name="production_secret_key" class="form-control" value="<?php echo $paypal[0]->production_secret_key;?>" required />
                    <?php else: ?>
                        <input type="text" name="production_secret_key" class="form-control" placeholder="<?php echo get_phrase('no_secret_key_found'); ?>" required />
                    <?php endif; ?>
                </div>
