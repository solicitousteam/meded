        ...
        <div class="card">
            <div class="card-body">
                <h4 class="page-title">
                    ...
                    <img src="<?= base_url('uploads/cash-on-delivery.png')?>" style="height: 44px; width: 44px;"
                        alt="user-image">
        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <li class="nav-item">
                        <a href="#pending-b1" data-toggle="tab" aria-expanded="false" class="nav-link">
                            ...
                            <span class="d-none d-lg-block"><?php echo get_phrase('pending_payouts'); ?> <span
                                    class="badge badge-danger-lighten"><?php echo $pending_payouts->num_rows(); ?></span></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#subscription-b1" data-toggle="tab" aria-expanded="false" class="nav-link">
                            <i class="mdi mdi-home-variant d-lg-none d-block mr-1"></i>
                ...
                <div class="tab-content">
                        ...
                        <div class="row justify-content-md-center">
                            <div class="col-xl-6">
                                <form class="form-inline"
                                    action="<?php echo site_url('admin/instructor_payout/filter_by_date_range') ?>"
                                    method="get">
                                    <div class="col-xl-10">
                                        <div class="form-group">
                                            <div id="reportrange" class="form-control" data-toggle="date-picker-range"
                                                ...
                                                <span
                                                    id="selectedValue"><?php echo date("F d, Y", $timestamp_start) . " - " . date("F d, Y", $timestamp_end); ?></span>
                            ...
                            <table id="completed-payout" class="table table-striped table-centered mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr class="gradeU">
                                        <td> <?php echo ++$key; ?> </td>
                                        <td>
                                            <img src="<?php echo $this->user_model->get_user_image_url($completed_payout_user_data['id']); ?>"
                                        ...
                                        <td> <a href="<?php echo site_url('admin/invoice/' . $completed_payout['id']); ?>"
                            ...
                            <table id="pending-payout" class="table table-striped table-centered mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr class="gradeU">
                                        <td> <?php echo ++$key; ?> </td>
                                        <td>
                                            <img src="<?php echo $this->user_model->get_user_image_url($pending_payout_user_data['id']); ?>"
                                                alt="" height="50" width="50"
                                                class="img-fluid rounded-circle img-thumbnail">
                                        </td>
                                        <td>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <form
                                                action="<?php echo site_url('admin/paypal_checkout_for_instructor_revenue'); ?>"
                                                method="post">
                                                <input type="hidden" name="amount_to_pay"
                                                    value="<?php echo $pending_payout['amount']; ?>">
                                                <input type="hidden" name="payout_id"
                                                    value="<?php echo $pending_payout['id']; ?>">
                                                <input type="hidden" name="instructor_name"
                                                    value="<?php echo $pending_payout_user_data['first_name'] . ' ' . $pending_payout_user_data['last_name']; ?>">
                                                <input type="hidden" name="production_client_id"
                                                    value="<?php echo $paypal_keys[0]['production_client_id']; ?>">
                                                <input type="submit" class="btn btn-outline-info btn-sm btn-rounded"
                                                    value="<?php echo get_phrase('pay_with_paypal'); ?>">
                                            </form>
                                            <?php else : ?>
                                            <button type="button" class="btn btn-outline-danger btn-sm btn-rounded"
                                                name="button"
                                                onclick="alert('<?php echo get_phrase('this_instructor_has_not_provided_valid_paypal_client_id'); ?>')"><?php echo get_phrase('pay_with_paypal'); ?></button>
                                            <?php endif; ?>
                                            ...
                                            <?php endif; ?>
                                            <?php else : ?>
                                            <a href="<?php echo site_url('admin/invoice/' . $pending_payout['id']); ?>"
                                                class="btn btn-outline-primary btn-rounded btn-sm"><i
                    ...
                    <div class="tab-pane" id="subscription-b1">
                        <div class="table-responsive-sm mt-4">
                            <table id="subs-payout" class="table table-striped table-centered mb-0">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Order Number</th>
                                        ...
                                        <th>Payment Detail from Paytm</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php foreach ($subscriptions->result_array() as $key => $subscription) :
                                        $user_data = $this->db->get('users', array('id' => $subscription['user_id']))->row_array();
                                    ?>
                                    <tr class="gradeU">
                                        <td> <?= ++$key; ?> </td>
                                        <td><?= $subscription['order_id'] ?></td>
                                        <td><?= $subscription['txn_id'] ?></td>
                                        <td><?= $subscription['subscription_payment_status'] ?></td>
                                        <td><?= $user_data['email'] ?></td>
                                        <td><?= $subscription['subscription_amount'] ?></td>
                                        <td><?= date('Y-m-d', strtotime($subscription['subscription_entry_date'])) ?>
                                        </td>
                                        <td><?= $subscription['subscription_expire_date'] ?></td>
                                        <td><?= $subscription['subscription_status'] ?></td>
                                        <td>
                                            <a
                                                href="<?= base_url() . 'admin/txnStatus/' . $subscription['order_id'] ?>"><i
