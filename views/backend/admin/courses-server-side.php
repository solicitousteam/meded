        ...
        <div class="card">
            <div class="card-body">
                <h4 class="page-title">
                    ...
                    <img src="https://main.solicitous.cloud/meded4/uploads/online-learning.png"
                        style="height: 44px; width: 44px;" alt="user-image">
                    <?php echo get_phrase('blended_courses'); ?>
                    <a href="<?php echo site_url('admin/course_form/add_course'); ?>"
            ...
            <div class="card-body p-0">
                <div class="row no-gutters">
                    <div class="col-sm-6 col-xl-3">
                        <a href="<?php echo site_url('admin/courses_list?status=active&category_type=0'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0">
                                <div class="card-body text-center">
                                    <!--<i class="dripicons-link text-muted" style="font-size: 24px;"></i>-->
                                    <img src="https://main.solicitous.cloud/meded4/uploads/verified-user.png"
                                        style="height: 44px; width: 44px;" alt="user-image">
                                    <h3><span>
                                    <?php
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <a href="<?php echo site_url('admin/courses_list?status=pending&category_type=0'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    <!--<i class="dripicons-link-broken text-muted" style="font-size: 24px;"></i>-->
                                    <img src="https://main.solicitous.cloud/meded4/uploads/clock.png"
                                        style="height: 44px; width: 44px;" alt="user-image">
                                    <h3><span>
                                     <?php
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <a href="<?php echo site_url('admin/courses_list?is_free=free&category_type=0'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    <!--<i class="dripicons-star text-muted" style="font-size: 24px;"></i>-->
                                    <img src="https://main.solicitous.cloud/meded4/uploads/free.png"
                                        style="height: 44px; width: 44px;" alt="user-image">
                                    <h3><span>
                                        <?php// echo $this->crud_model->get_free_and_paid_courses('free',0,0)->num_rows(); ?></span>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <a href="<?php echo site_url('admin/courses_list?is_free=paid&category_type=0'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    <!--<i class="dripicons-tags text-muted" style="font-size: 24px;"></i>-->
                                    <img src="https://main.solicitous.cloud/meded4/uploads/paid.png"
                                        style="height: 44px; width: 44px;" alt="user-image">
                                    <h3><span>
                                   ...
                                   <?php
                                     $active_courses2 = $this->crud_model->free_count_blended('0',0);
                                        ...
                                        <?php// echo $this->crud_model->get_free_and_paid_courses('paid',0,0)->num_rows(); ?></span>
                                    </h3>
...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="mb-3 header-title"><?php echo get_phrase('blended_course_list'); ?></h4>
                <form class="row" id="filter-form" action="<?php echo site_url('admin/courses'); ?>" method="get">
                    <!-- Course Categories -->
                    <div class="col-xl-5">
                    ...
                    <div class="col-xl-2">
                        <label for=".." class="text-white">..</label>
                        <!--<button type="button" class="btn btn-warning btn-block" form="filter-form" page="blendedcourse" onclick="exportdata(this,'excel');">Export To Excel</button>-->
                    
                    <form method="get" action="<?php echo site_url('admin/courses'); ?>">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <img src="<?= $Cours['thumbnail']; ?>"
                                    alt="" style="height: 300px; max-width: 100%;">
                                ...
                                <div class="float-right"><b><?php echo $UserData["first_name"] ?>
                                        <?php echo $UserData["last_name"] ?></b></div>
                                <div class="clearfix"></div>
                                ...
                                <div class="float-right dropright dropright">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="<?php echo site_url('admin/start_live_class/'.$Cours['id'].'?sendnotification=1'); ?>" target="_blank">Start Live Class</a></li>
                                              ...
                                              <li><a class="dropdown-item" href="<?php echo site_url('admin/course_form/course_edit/'.$Cours['id']); ?>"><?php echo get_phrase('edit_this_course');?></a></li>
                                              <li><a class="dropdown-item" href="<?php echo site_url('admin/course_form/course_edit/'.$Cours['id']); ?>?curriculum"><?php echo get_phrase('section_and_lesson');?></a></li>
                                              <li>
                                                  <?php if ($Cours['status'] == 'active'): ?>
                                                      
                                                          <a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url();?>admin/change_course_status_for_admin/pending/<?php echo $Cours['id']; ?>/<?php echo $selected_category_id; ?>/<?php echo $selected_instructor_id; ?>/<?php echo $selected_price; ?>/<?php echo $selected_status;?>', '<?php echo get_phrase('inform_instructor'); ?>');">
                                                              <?php echo get_phrase('mark_as_pending');?>
                                                          </a>
                                                  <?php else: ?>   
                                                          <a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url();?>admin/change_course_status_for_admin/active/<?php echo $Cours['id']; ?>/<?php echo $selected_category_id; ?>/<?php echo $selected_instructor_id; ?>/<?php echo $selected_price; ?>/<?php echo $selected_status;?>', '<?php echo get_phrase('inform_instructor'); ?>');">
