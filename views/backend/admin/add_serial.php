    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <p class="p-mb-15">➔ Serial Learning courses (SL)(Pre recorded or live clases or mixed series of videos classes for a single topic or multiple topics)</p>

                <p class="p-mb-15">➔ SL courses are designed to teach via video medium which can be prerecorded or live, but has a continuity.</p>
                
                <p class="p-mb-15">➔ The classes can be on a single topic or multiple topics.</p>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a href="<?php echo site_url('admin/serial_learning'); ?>"
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <form class="required-form" action="<?php echo site_url('admin/serial_learning/add'); ?>"
                                ...
                                <div class="tab-content b-0 mb-0">
                                            ...
                                            <div class="col-xl-10">
                                                <div class="col-lg-12">
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="text" name="title" id="title" class="form-control tab-1" value="" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row mb-3">
                                                        <label class="col-md-2" for="description"><?php echo get_phrase('description'); ?><span class="required">*</span></label>
                                                        <div class="col-md-10">
                                                            <input type="text" name="description" id="descriptions" class="form-control tab-1" value="" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row mb-3">
                                                        <label class="col-md-2" for="topic"><?php echo get_phrase('topic'); ?><span class="required">*</span></label>
                                                        <div class="col-md-10">
                                                            <input type="text" name="topic" id="topic" class="form-control tab-1" value="" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row mb-3">
                                                        <label class="col-md-2 col-form-label" for="sub_category_id"><?php echo get_phrase('department'); ?><span
                                                            ...
                                                            <div class="d-flex mt-2">
                                                                <div class="flex-grow-1 px-3">
                                                                    <div class="form-group">
                                                                        <input required type="text" class="form-control tab-2" name="objectives[]" id="objectives" placeholder="<?php echo get_phrase('objectives'); ?>" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-xl-10">
                                                <div class="form-group row mb-3">
                                                    <div class="offset-md-2 col-md-10">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input price_change" name="is_free_course" id="is_free_course" onclick="check_checkbox('price')">
                                                            <label class="custom-control-label"
                                                ...
                                                <div class="paid-course-stuffs">
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="number" oninput="course_amount_valid('price')" class="form-control price_change tab-3" id="price" name="price"  value="0" required placeholder="<?php echo get_phrase('enter_course_course_price'); ?>"
                                                                min="0">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        <div class="offset-md-2 col-md-10">
                                                            <div class="custom-control custom-checkbox">
                                                                <input type="checkbox" class="custom-control-input price_change" onclick="check_checkbox('discounted_price')" name="discount_flag" id="discount_flag" value="1">
                                                                <label class="custom-control-label"
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="number" class="form-control price_change tab-3" required name="discounted_price" id="discounted_price"
                                                                oninput="course_amount_valid('discounted_price')"
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2" for="duration"><?php echo get_phrase('duration'); ?><span class="required">*</span></label>
                                                    <div class="col-md-10">
                                                        <input type="number" name="duration" id="duration"  class="form-control tab-3" min=0 oninput="validity.valid||(value='');" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- end col -->
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-xl-10">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="file" name="course_thumbnail" id="course_thumbnail" class="form-control tab-4" value="" accept="image/*" required>
                                                    </div>
                                                </div>

                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2" for="code"><?php echo get_phrase('course_video'); ?><span class="required">*</span></label>
                                                    <div id="video_area" class="col-md-10">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <label for="video_title"><?php echo get_phrase('video_title'); ?><span class="required">*</span></label>
                                                                <input type="text" name="video_title[]" id="video_title" class="form-control tab-4" required>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <label for="video_description"><?php echo get_phrase('video_description'); ?><span class="required">*</span></label>
                                                                <textarea name="video_description[]" id="video_description" class="form-control tab-4" required></textarea>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <div class="d-flex mt-2">
                                                                    <div class="flex-grow-1 pr-2">
                                                                        <div class="form-group">
                                                                            <input type="file" name="course_video[]" accept="video/*"
                                                                                class="form-control tab-4" value="" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="">
                                                                        <button type="button" class="btn btn-success btn-sm"
                                                                            name="button" onclick="appendVideo()"> <i
                                                                                class="fa fa-plus"></i> </button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--<div id="blank_video_field" >-->
                                                        <!--    <div class="row">-->
                                                        <!--        <div class="col-md-12">-->
                                                        <!--            <label for="video_title1"><?php echo get_phrase('video_title'); ?><span class="required">*</span></label>-->
                                                        <!--            <input type="text" name="video_title[]" id="video_title" class="form-control  tab-4" value="" >-->
                                                        <!--        </div>-->
                                                        <!--        <div class="col-md-12">-->
                                                        <!--            <label for="video_description1"><?php echo get_phrase('video_description'); ?><span class="required">*</span></label>-->
                                                        <!--            <textarea name="video_description[]" id="video_description" class="form-control  tab-4" value="" ></textarea>-->
                                                        <!--        </div>-->
                                                        <!--        <div class="col-md-12">-->
                                                        <!--            <div class="d-flex mt-2">-->
                                                        <!--                <div class="flex-grow-1 px-3">-->
                                                        <!--                    <div class="form-group">-->
                                                        <!--                        <input type="file" name="course_video[]" accept="video/*"-->
                                                        <!--                            class="form-control  tab-4" value="">-->
                                                        <!--                    </div>-->
                                                        <!--                </div>-->
                                                        <!--                <div class="">-->
                                    ...
                                    <div class="tab-pane" id="curriculum">
                                        ...
                                        <ul class="list-inline mb-0 wizard text-center">
                                            ...
                                            <!-- <li class="list-inline-item">
                                                <a href="javascript:void(0);" onclick="getpreviewdata(1);" class="btn btn-info">
                                                    <i class="mdi mdi-arrow-right-bold"></i>
                                                </a>
                                            </li> -->
                                        </ul>
...
var blank_video = '<div class="row">';
    blank_video += '     <div class="col-md-12">';
    blank_video += '         <label for="video_title1"><?php echo get_phrase('video_title'); ?><span class="required">*</span></label>';
    blank_video += '          <input type="text" name="video_title[]" id="video_title" class="form-control  tab-4" value="" >';
    blank_video += '     </div>';
    blank_video += '     <div class="col-md-12">';
    blank_video += '         <label for="video_description1"><?php echo get_phrase('video_description'); ?><span class="required">*</span></label>';
    blank_video += '         <textarea name="video_description[]" id="video_description" class="form-control  tab-4" value="" ></textarea>';
    blank_video += '     </div>';
    blank_video += '     <div class="col-md-12">';
    blank_video += '         <div class="d-flex mt-2">';
    blank_video += '             <div class="flex-grow-1 px-3">';
    blank_video += '                 <div class="form-group">';
    blank_video += '                     <input type="file" name="course_video[]" accept="video/*" class="form-control  tab-4" value="">';
    blank_video += '                 </div>';
    blank_video += '             </div>';
    blank_video += '             <div class="">';
    blank_video += '                 <button type="button" class="btn btn-danger btn-sm" style="margin-top: 0px;" name="button" onclick="removeVideo(this)"> <i class="fa fa-minus"></i> </button>';
    blank_video += '             </div>';
    blank_video += '         </div>';
    blank_video += '     </div>';
    blank_video += ' </div>';
...
function removeVideo(outcomeElem) {
    jQuery(outcomeElem).parent().parent().parent().parent().remove();
}
...
function pricevalidation()
{
 ...
 function course_amount_valid(from = '')
    {
       ...
       $('#price').val(Math.abs($('#price').val()));
        ...
        {
            $('#discounted_price').val(Math.abs($('#discounted_price').val()));
