...
<form action="<?php echo site_url('admin/lessons/'.$param2.'/add'); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label><?php echo get_phrase('section'); ?><span class="required">*</span></label>
    ...
    <div class="form-group">
        <label><?php echo get_phrase('summary'); ?><span class="required">*</span></label>
        <textarea name="summary" required class="form-control"></textarea>
    </div>
