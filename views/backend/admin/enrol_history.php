            ...
            <div class="card-body">
                <h4 class="page-title">
                     <!--<i class="mdi mdi-apple-keyboard-command title_icon"></i> -->
                      <img src="<?= base_url('uploads/refresh (1).png')?>" style="height: 44px; width: 44px;"alt="user-image">
                     <?php echo get_phrase('enroll_history'); ?></h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
</div>
...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
              <h4 class="mb-3 header-title"><?php echo get_phrase('enroll_histories'); ?></h4>
              <div class="row justify-content-md-end mr-2">
                  <div class="col-xl-6">
                      <form class="form-inline" action="<?php echo site_url('admin/enrol_history/filter_by_date_range') ?>" method="get">
                          <div class="col-xl-7">
                              <div class="form-group">
                                  <div id="reportrange" class="form-control" data-toggle="date-picker-range" data-target-display="#selectedValue"  data-cancel-class="btn-light" style="width: 601px;margin-left: -475px;">
                        ...
                        <div class="col-xl-3">
                            <select name="userstype" id="userstype" class="form-control select2">
                            <option >All</option>
                            <option >Paid</option>
                          ...
                          <div class="col-xl-2">
                              <button type="submit" class="btn btn-info" id="submit-button" onclick="update_date_range();"> <?php echo get_phrase('filter');?>
