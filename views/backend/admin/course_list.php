<?php 
$instructor_url = (!empty($_GET['instructor_id'])) ? '&instrutor_id='.$_GET['instructor_id'] : '';
$selected_instructor_id = (!empty($_GET['instructor_id'])) ? $_GET['instructor_id'] : 0;
?>
        ...
        <div class="card widget-inline">
            <div class="card-body p-0">
                <div class="row no-gutters">
                    <div class="col">
                        <a href="<?php echo site_url('admin/courses_list?status=active&category_type='.$category_type.$instructor_url); ?>" class="text-secondary">
                            <div class="card shadow-none m-0">
                                <div class="card-body text-center">
                                    ...
                                    <h3><span>
                                         <?php
                                        //     $active_courses = $this->crud_model->get_status_wise_courses('active',$category_type);
                                        //     echo $active_courses->num_rows();
                                          ?>
                                         
                                         <?php
                                            $active_courses = $this->crud_model->course_count('active',0);
                    ...
                    <div class="col">
                        <a href="<?php echo site_url('admin/courses_list?status=pending&category_type='.$category_type.$instructor_url); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <h3><span>
                                         <?php
                                        //     $pending_courses = $this->crud_model->get_status_wise_courses('pending',$category_type);
                                        //     echo $pending_courses->num_rows();
                                          ?>
                                         <?php
                                            $active_courses = $this->crud_model->course_count('pending',0);
                                            echo count($active_courses);
                                         ?>
                                    </span></h3>
                    ...
                    <div class="col">
                        <a href="<?php echo site_url('admin/courses_list?is_free=free&category_type='.$category_type.$instructor_url); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <h3><span>
                                        <?php
                                       // echo $this->crud_model->get_free_and_paid_courses('free', $selected_instructor_id,$category_type)->num_rows();
                                        
                                        ?>
                                        
                                        <?php
                                     $active_courses2 = $this->crud_model->free_count_blended('1',0);
                                            echo count($active_courses2);
                    ...
                    <div class="col">
                        <a href="<?php echo site_url('admin/courses_list?is_free=paid&category_type='.$category_type.$instructor_url); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <h3><span>
                                         <?php
                                     $active_courses2 = $this->crud_model->free_count_blended('0',0);
                                            echo count($active_courses2);
                                            
                                            ?>
                                        
                                        
                                        <?php// echo $this->crud_model->get_free_and_paid_courses('paid', $selected_instructor_id,$category_type)->num_rows(); ?></span></h3>
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="row justify-content-center" action="<?php echo site_url('admin/courses_list'); ?>" method="get">
                    <?php
                    
                    if(!empty($_GET['status']))
                    {
                        echo '<input type="hidden" value="'.$_GET['status'].'" name="status">';
                    }
                    if(isset($_GET['category_type']))
                    {
                        echo '<input type="hidden" value="'.(($_GET['category_type'] == false) ? '0' : $_GET['category_type']).'" name="category_type">';
                    }
                        
                    if(!empty($_GET['is_free']))
                    {
                        echo '<input type="hidden" value="'.$_GET['is_free'].'" name="is_free">';
                    }
                    ?>
                ...
                <div class="col-xl-2">
                    <div class="form-group">
                        ...
                        <select class="form-control select2" data-toggle="select2" name="filter_status" id = 'status'>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="float-right dropright dropright">
                                          ...
                                          <ul class="dropdown-menu">
                                              <li><a class="dropdown-item" href="<?php echo site_url('admin/start_live_class/'.$Cours['id']); ?>" target="_blank">Start Live Class</a></li>
                                              <li><a class="dropdown-item" href="<?php echo site_url('home/course/'.slugify($Cours['title']).'/'.$Cours['id']); ?>" target="_blank">Preview</a></li>
                                              <li><a class="dropdown-item" href="<?php echo site_url('admin/course_redirect_form/'.$Cours['id']); ?>"><?php echo get_phrase('edit_this_course');?></a></li>
                                              <li>
                                                <?php if ($course['status'] == 'active') : ?>
                                                <?php if ($course['user_id'] != $this->session->userdata('user_id')) : ?>
                                                <a class="dropdown-item" href="#"
                                                    onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/mail_on_course_status_changing_modal/pending/<?php echo $course['id']; ?>/<?php echo $selected_category_id; ?>/<?php echo $selected_instructor_id; ?>/<?php echo $selected_price; ?>/<?php echo $selected_status; ?>', '<?php echo get_phrase('inform_instructor'); ?>');">
                                                    <?php echo get_phrase('mark_as_pending'); ?>
                                                </a>
                                                <?php else : ?>
                                                <a class="dropdown-item" href="#"
                                                    onclick="confirm_modal('<?php echo site_url(); ?>admin/change_course_status_for_admin/pending/<?php echo $course['id']; ?>/<?php echo $selected_category_id; ?>/<?php echo $selected_instructor_id; ?>/<?php echo $selected_price; ?>/<?php echo $selected_status; ?>', '<?php echo get_phrase('inform_instructor'); ?>');">
                                                    <?php echo get_phrase('mark_as_pending'); ?>
                                                </a>
                                                <?php endif; ?>
                                                <?php else : ?>
                                                <?php if ($course['user_id'] != $this->session->userdata('user_id')) : ?>
                                                <a class="dropdown-item" href="#"
                                                    onclick="confirm_modal('<?php echo site_url(); ?>admin/change_course_status_for_admin/active/<?php echo $course['id']; ?>/<?php echo $selected_category_id; ?>/<?php echo $selected_instructor_id; ?>/<?php echo $selected_price; ?>/<?php echo $selected_status; ?>', '<?php echo get_phrase('inform_instructor'); ?>');">
                                              ...
                                              <?php if($course['course_type'] != 'scorm'): ?>
                                                  <li><a class="dropdown-item" href="<?php echo site_url('admin/course_redirect_form/'.$course['id']); ?>"><?php echo get_phrase('section_and_lesson');?></a></li>
                                              <?php endif; ?>
                                              <li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('admin/course_delete/'.$course['id']); ?>');"><?php echo get_phrase('delete'); ?></a></li>
                                          </ul>
                                      </div>
                                    </div>
                                </div>
