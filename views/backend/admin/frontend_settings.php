...
<div class="row ">
    <div class="col-xl-12">
                <h4 class="page-title"> 
                <img src="<?= base_url('uploads/web-maintenance.png')?>" style="height: 44px; width: 44px;"alt="user-image"> 
                <!--<i class="mdi mdi-apple-keyboard-command title_icon"></i> -->
                <?php echo"&nbsp;&nbsp;&nbsp;". get_phrase('Website_settings'); ?></h4>
            </div>
...
<div class="row justify-content-center">
    ...
    <div class="col-xl-4 col-lg-6">
        <div class="card">
            <div class="card-body">
                <div class="col-lg-12">
                    <h4 class="mb-3 header-title">Blended Learning</h4>
                    <div class="row justify-content-center">
                        <form action="<?php echo site_url('admin/frontend_settings/blended_learning'); ?>" method="post" enctype="multipart/form-data" style="text-align: center;">
                            <div class="form-group mb-2">
                                <div class="wrapper-image-preview">
                                    <div class="box" style="width: 250px;">
                                        <div class="js--image-preview" style="background-image: url(<?php echo base_url('uploads/system/'.get_frontend_settings('blended_learning')); ?>); background-color: #F5F5F5;"></div>
                                        <div class="upload-options">
                                            <label for="blended_learning" class="btn"> <i class="mdi mdi-camera"></i> Blended Learning</label>
                                            <input id="blended_learning" style="visibility:hidden;" type="file" class="image-upload" name="blended_learning" accept="image/*">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="col-xl-4 col-lg-6">
        <div class="card">
            <div class="card-body">
                <div class="col-lg-12">
                    <h4 class="mb-3 header-title">Video Learning</h4>
                    <div class="row justify-content-center">
                        <form action="<?php echo site_url('admin/frontend_settings/video_learning'); ?>" method="post" enctype="multipart/form-data" style="text-align: center;">
                            <div class="form-group mb-2">
                                <div class="wrapper-image-preview">
                                    <div class="box" style="width: 250px;">
                                        <div class="js--image-preview" style="background-image: url(<?php echo base_url('uploads/system/'.get_frontend_settings('video_learning')); ?>); background-color: #F5F5F5;"></div>
                                        <div class="upload-options">
                                            <label for="video_learning" class="btn"> <i class="mdi mdi-camera"></i> Video Learning</label>
                                            <input id="video_learning" style="visibility:hidden;" type="file" class="image-upload" name="video_learning" accept="image/*">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="col-xl-4 col-lg-6">
        <div class="card">
            <div class="card-body">
                <div class="col-lg-12">
                    <h4 class="mb-3 header-title">Serial Learning</h4>
                    <div class="row justify-content-center">
                        <form action="<?php echo site_url('admin/frontend_settings/serial_learning'); ?>" method="post" enctype="multipart/form-data" style="text-align: center;">
                            <div class="form-group mb-2">
                                <div class="wrapper-image-preview">
                                    <div class="box" style="width: 250px;">
                                        <div class="js--image-preview" style="background-image: url(<?php echo base_url('uploads/system/'.get_frontend_settings('serial_learning')); ?>); background-color: #F5F5F5;"></div>
                                        <div class="upload-options">
                                            <label for="serial_learning" class="btn"> <i class="mdi mdi-camera"></i> Serial Learning</label>
                                            <input id="serial_learning" style="visibility:hidden;" type="file" class="image-upload" name="serial_learning" accept="image/*">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="col-xl-4 col-lg-6">
        <div class="card">
            <div class="card-body">
                <div class="col-lg-12">
                    <h4 class="mb-3 header-title">Webinars</h4>
                    <div class="row justify-content-center">
                        <form action="<?php echo site_url('admin/frontend_settings/webinars'); ?>" method="post" enctype="multipart/form-data" style="text-align: center;">
                            <div class="form-group mb-2">
                                <div class="wrapper-image-preview">
                                    <div class="box" style="width: 250px;">
                                        <div class="js--image-preview" style="background-image: url(<?php echo base_url('uploads/system/'.get_frontend_settings('webinars')); ?>); background-color: #F5F5F5;"></div>
                                        <div class="upload-options">
                                            <label for="webinars" class="btn"> <i class="mdi mdi-camera"></i> Webinars</label>
                                            <input id="webinars" style="visibility:hidden;" type="file" class="image-upload" name="webinars" accept="image/*">
                                        </div>
                                    </div>
                                </div>
                            </div>
