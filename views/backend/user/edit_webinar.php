    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <?php echo get_phrase('webinar_add_form'); ?></h4>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a href="<?php echo site_url('user/webinar'); ?>" class="alignToTitle btn btn-outline-secondary btn-rounded btn-sm my-1"> <i class=" mdi mdi-keyboard-backspace"></i> <?php echo get_phrase('back_to_course_list'); ?></a>
                        
                    </div>
                </div>
                       <div class="row">
                    <div class="col-xl-12">
                        <form class="required-form" action="<?php echo site_url('user/webinar/update/'.$webinar->id); ?>" enctype="multipart/form-data" method="post">
                             <div id="basicwizard">
                                    ...
                                    <div class="col-xl-10">
                                        <div class="form-group row mb-3">
                                            <div class="offset-md-2 col-md-10">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" name="is_free_course" id="is_free_course" value="1" <?php if($webinar->is_free_course == 1) echo 'checked'; ?> onclick="check_checkbox('price');">
                                        ...
                                        <div class="paid-course-stuffs">
                                            <div class="form-group row mb-3">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="number" class="form-control tab-3" oninput="course_amount_validation('price');" id="price" required name = "price" min="0" placeholder="<?php echo get_phrase('enter_course_course_price'); ?>" value="<?php echo $webinar->price; ?>" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row mb-3">
                                                <div class="offset-md-2 col-md-10">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input" name="discount_flag" id="discount_flag" value="1" <?php if($webinar->discount_flag == 1) echo 'checked'; ?> onclick="check_checkbox('discounted_price');">
                                            ...
                                            <div class="form-group row mb-3">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="number" class="form-control tab-3" oninput="course_amount_validation('discounted_price');" name="discounted_price" required id="discounted_price" onkeyup="calculateDiscountPercentage(this.value)" value="<?php echo $webinar->discounted_price; ?>" min="0">
                                                    ...
                                                    <div class="flex-grow-1 px-3">
                                                        <div class="form-group">
                                                            <input type="file" name="thumbnail" id="thumbnail"
                                                                class="form-control tab-5" value=""  <?= (!empty($webinar->thumbnail)) ? '' : 'required';?> >
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
