...
<div class="row ">
   ...
   <h4 class="page-title"> 
                ...
                <img src="<?= base_url('uploads/business-credit-report.png')?>" style="height: 35px; width: 30px;"alt="user-image">
                <?php echo get_phrase('payout_report'); ?>
...
<!---<img src="https://ai24x7.com/uploads/Bannersmeded-04 (1).jpg" style="height: 260px; width: 100%;"alt="user-image">--->
    ...
    <div class="col-lg-4">
        <div class="card text-white bg-danger">
            <div class="card-body">
                ...
                <h3 class="mt-3 mb-3">
                    <span class="text-white"><i class=""></i></span>
