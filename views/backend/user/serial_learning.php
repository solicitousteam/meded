        ...
        <div class="card">
            <div class="card-body">
                ...
                <?php echo get_phrase('Serial Learning'); ?>
                  <a href="<?php echo site_url('user/serial_learning/add_form'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"><i class="mdi mdi-plus"></i><?php echo get_phrase('add_new_serial_learning'); ?></a>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
            ...
            <div class="card-body p-0">
                <div class="row no-gutters">
                    <div class="col-sm-6 col-xl-3">
                        <a href="<?php echo site_url('user/courses_list?status=active&category_type=2'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0">
                                <div class="card-body text-center">
                                    ...
                                    <h3><span><?php echo $this->crud_model->get_status_wise_courses_for_instructor('active',2)->num_rows(); ?></span></h3>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <a href="<?php echo site_url('user/courses_list?status=pending&category_type=2'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <h3><span><?php echo $this->crud_model->get_status_wise_courses_for_instructor('pending',2)->num_rows(); ?></span></h3>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <a href="<?php echo site_url('user/courses_list?is_free=free&category_type=2'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <h3><span><?php echo $this->crud_model->get_free_and_paid_courses('free',$this->session->userdata('user_id'),2)->num_rows(); ?></span></h3>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <a href="<?php echo site_url('user/courses_list?is_free=paid&category_type=2'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <h3><span><?php echo $this->crud_model->get_free_and_paid_courses('paid',$this->session->userdata('user_id'),2)->num_rows(); ?></span></h3>
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="row justify-content-center" action="<?php echo site_url('user/serial_learning'); ?>" method="get">
                    <!-- Course Categories -->
                    <div class="col-xl-5">
                                            ...
                                            <div class="col-md-5 col-sm-5 col-xs-12">
                                                <div class="float-right dropright dropright">
                                                  ...
                                                  <ul class="dropdown-menu">
                                                      <li><a class="dropdown-item" href="<?php echo site_url('user/start_live_class/'.$Cours['id'].'?sendnotification=1'); ?>" target="_blank">Start Live Class</a></li>
                                                     <li><a class="dropdown-item" href="<?php echo site_url('home/course/'.slugify($Cours['title']).'/'.$Cours['id']); ?>" target="_blank">Preview</a></li>
                                             
                                                      <li><a class="dropdown-item" href="<?php echo site_url('user/serial_learning/edit_form/'.$Cours['id']); ?>"><?php echo get_phrase('edit_this_course');?></a></li>
                                                      
                                                      <li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('user/course_actions/deletevideo/'.$course['id']); ?>');"><?php echo get_phrase('delete'); ?></a></li>
                                                  </ul>
                                              </div>
                                            </div>
                                        </div>
