        ...
        <div class="card">
            <div class="card-body">
                <h4 class="page-title">
                    ...
                    <?php echo get_phrase('webinar_add_form'); ?>
                </h4>
                <!--<p class="mb-15"><strong>- Pick a unique topic that interests you.</strong></p>-->

                <!--<p class="mb-15"><strong>- Pre-recorded video.</strong></p>-->
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a href="<?php echo site_url('user/webinar'); ?>"
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <form class="required-form" action="<?php echo site_url('user/webinar/add'); ?>"
                                ...
                                <ul class="nav nav-pills nav-justified form-wizard-header">
                                    ...
                                    <li class="nav-item">
                                        <a href="#details" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2">
                                            ...
                                            <span class="d-none d-sm-inline"><?php echo get_phrase('duration detail'); ?></span>
                                        </a>
                                    </li>
                                ...
                                <div class="tab-content b-0 mb-0">
                                            ...
                                            <div class="col-xl-10">
                                                <div class="col-lg-12">
                                                    <div class="form-group row mb-3">
                                                        <label class="col-md-2" for="first_name"><?php echo get_phrase('first_name'); ?><span class="required">*</span></label>
                                                        <div class="col-md-10">
                                                            <input type="text" name="first_name" id="first_name" class="form-control tab-1" value="" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row mb-3">
                                                        <label class="col-md-2" for="last_name"><?php echo get_phrase('last_name'); ?><span class="required">*</span></label>
                                                        <div class="col-md-10">
                                                            <input type="text" name="last_name" id="last_name" class="form-control tab-1" value="" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row mb-3">
                                                        <label class="col-md-2" for="email"><?php echo get_phrase('email'); ?><span class="required">*</span></label>
                                                        <div class="col-md-10">
                                                            <input type="text" name="email" id="email" class="form-control tab-1" value="" required>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="tab-pane" id="webinar-detail">
                                            ...
                                            <div class="col-xl-10">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="title" id="title" class="form-control tab-5" value="" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="agenda"></label>
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            <label
                                                            ...
                                                            <textarea rows="5" name="pain_point" id="pain_point" class="form-control tab-5" required></textarea>
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea rows="5" name="cta" id="cta" class="form-control tab-5"
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            <label
                                                                for="anything_else"><?php echo get_phrase('Anything else we should know?'); ?><span class="required">*</span></label>
                                                            <textarea rows="5" name="anything_else" id="anything_else" class="form-control tab-5" placeholder="" required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <ul class="list-inline mb-0 wizard text-center">
                                            ...
                                            <li class="list-inline-item">
                                                <button type="button" class="btn btn-info" onclick="return verifyrequired('tab-5','details');"> <i class="mdi mdi-arrow-right-bold"></i> </button>
                                            </li>
                                        </ul>
                                    </div>
                                            ...
                                            <div class="col-xl-10">
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label"
                                                        for="details"><?php echo get_phrase('details'); ?></label>
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            <label for="proposed_date"><?php echo get_phrase('course_start_date'); ?><span class="required">*</span></label>
                                                             <input type="date" onkeydown="return false" name="proposed_date" id="proposed_date" class="form-control tab-2 date_picker" required  min="<?= date('m/d/Y');?>" max="2050-01-01">
                                                          ...
                                                          $('.date_picker').attr('min',today);
                                                            ...
                                                            <!--<input type="text" name="proposed_date" id="proposed_date" class="form-control tab-2 date" required data-toggle="date-picker" data-min-date="<?= date('m/d/Y');?>" data-single-date-picker="true" value="<?= date('m/d/Y');?>">-->
                                                        </div>
                                                        <?php /*?>
                                                        <div class="form-group">
                                                            <label for="end_date"><?php echo get_phrase('course_end_date'); ?><span class="required">*</span></label>
                                                            <input type="text" class="form-control tab-2 date" id="end_date" name="end_date" required data-toggle="date-picker" data-min-date="<?= date('m/d/Y');?>" data-single-date-picker="true" value="<?= date('m/d/Y');?>">
                                                        </div>
                                                        <?php */?>
                                                        <div class="form-group">
                                                            <label for="proposed_time"><?php echo get_phrase('time'); ?><span class="required">*</span></label>
                                                            <input type="text" name="proposed_time" id="proposed_time"
                                                                class="form-control tab-2" data-toggle="timepicker"   value="00:00:00" required>
                                                        </div>
                                                       
                                                        <div class="form-group">
                                                            <label
                                                                for="duration"><?php echo get_phrase('duration (hours)'); ?><span class="required">*</span></label>
                                                            <select class="form-control tab-2" name="duration" id="duration" required>
                                                            <?php
                                                            $num = 0.5;
                                                            for($i=0.5;$i<=12;$i = $i + 0.5)
                                                            {
                                                                echo '<option value="'.$i.'">'.number_format($i, 1, '.', '').' Hours</option>';
                                                            }?>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="number" class="form-control price_change tab-3" id="price"
                                                                name="price" min="0" required oninput="this.value = 
 !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null"
                                                                placeholder="<?php echo get_phrase('enter_course_price'); ?>"
                                                                value="<?php echo $course_details['price'] ?? 0 ?>" oninput="course_amount_validation('price');">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="number" class="form-control price_change tab-3"
                                                                name="discounted_price" id="discounted_price" required oninput="course_amount_validation('discounted_price');"
                                                                value="<?php echo $course_details['discounted_price'] ?? 0 ?>"
                                                                min="0" disabled>
                                                            <small
                                    ...
                                    <div class="tab-pane" id="media">
                                        <div class="row justify-content-center">
                                            <div class="col-xl-10">
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2" for="format"><?php echo get_phrase('format'); ?><span class="required">*</span></label>
                                                    <div class="col-md-10" id="video_area">
                                                        <div class="d-flex mt-2">
                                                            <div class="flex-grow-1 px-3">
                                                                <div class="form-group">
                                                                    <select name="format" id="format" class="form-control tab-4" onchange="
                                                                    if(this.value == 'other'){
                                                                        $('.other-format').css('display','block');
                                                                        $('#other-format').addClass('tab-4');
                                                                        $('#other-format').prop('required',true);
                                                                    }
                                                                    else{
                                                                        $('.other-format').css('display','none');
                                                                        $('#other-format').removeClass('tab-4');
                                                                        $('#other-format').prop('required',false);
                                                                    }
                                                                    " required>
                                                                        <option value="">Not Selected</option>
                                                                        <option value="powerpoint">Power Point</option>
                                                                        <option value="live speaker">Live Speaker</option>
                                                ...
                                                <div class="form-group row mb-3 other-format" style="display:none;">
                                                    <label class="col-md-2" for="other-format"><?php echo get_phrase('other format'); ?><span class="required">*</span></label>
                                                    <div class="col-md-10" id="video_area">
                                                        <div class="d-flex mt-2">
                                                            <div class="flex-grow-1 px-3">
                                                                <div class="form-group">
                                                                    <input type="text" name="other_format" id="other-format" class="form-control" >
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10" id="video_area">
                                                        <div class="d-flex mt-2">
                                                            <div class="flex-grow-1 px-3">
                                                                <div class="form-group">
                                                                    <input type="file" name="attachement[]" id="attachement" name="attachement"
                                                                        class="form-control tab-4" value="" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-8">
                                                        ...
                                                        <div class="what-you-get-box">
                                                            ...
                                                            <div class="what-you-get-title">
                                                                <?php echo site_phrase('Agenda'); ?>
                                                            </div>
                                                            <p class="what-you-get__items" id="pre_pain_point"></p>
                                                            
                                                            <br>
                                                            
                                                            <div class="what-you-get-title">
                                                                <?php echo site_phrase('cta'); ?>
                                                            </div>
                                                            <p class="what-you-get__items" id="pre_cta"></p>
                                                            
                                                            <br>
                                                            
                                                            <div class="what-you-get-title">
                                                                <?php echo site_phrase('other_benefits'); ?>
                                                            </div>
                                                            <p class="what-you-get__items" id="pre_anything_else"></p>
                                                            ...
                                                            <div class="description-box">
                                                                <div class="description-title">
                                                                    <?php echo site_phrase('Detail'); ?></div>
                                                                <div class="description-content-wrap">
                                                                    <div class="description-content" id="pre_detail"></div>
                                                                </div>
                                                            </div>
                                                        </div>
...
//     var description = 'Timing: ' + $('#proposed_date').val() + ' ' + $('#proposed_time').val() + '\n' +
//         'Duration: ' + $('#duration').val() + ' Hours';


//     var requirements = $('#pain_point').val();

//     var outcomes = $('#cta').val();

//     $('#pre_requirement').text(requirements);

//     $('#pre_objectives').text(outcomes);
...
{
    getcurriculum();
    $('#pre_course_title').text($('#title').val());
    ...
    // var short_description = $('textarea#short_description').val();
    $('#pre_detail').text('Timing: ' + $('#proposed_date').val() + ' ' + $('#proposed_time').val() + '\n' +
        'Duration: ' + $('#duration').val() + ' Hours');
    ...
    $('#pre_pain_point').html($('#pain_point').val());
    $('#pre_cta').html($('#cta').val());
    $('#pre_anything_else').html($('#anything_else').val());
