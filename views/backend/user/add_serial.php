        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a href="<?php echo site_url('user/serial_learning'); ?>"
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <form class="required-form" action="<?php echo site_url('user/serial_learning_add'); ?>"
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-xl-10">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        <label class="col-md-2" for="descriptions"><?php echo get_phrase('description'); ?><span class="required">*</span></label>
                                                        <div class="col-md-10">
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-md-10">
                                                            <select class="form-control select2 tab-1" data-toggle="select2" name="sub_category_id" id="sub_category_id" required>
                                                                <option value="">
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="number" class="form-control price_change tab-3" id="price"
                                                                name="price" oninput="this.value = 
 !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null" value="0" required oninput="course_amount_validation('price');"
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        <div class="offset-md-2 col-md-10">
                                                            <div class="custom-control custom-checkbox">
                                                                <input type="checkbox" class="custom-control-input price_change"
                                                                    name="discount_flag" id="discount_flag" value="1" onclick="check_checkbox('discounted_price');">
                                                                <label class="custom-control-label"
                                                ...
                                                <div class="form-group row mvb-3">
                                            ...
                                            <div class="col-xl-10">
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10" id="video_area">
                                                        ...
                                                        <!--    <div class="row">-->
                                                        <!--        <div class="col-md-12">-->
                                                        <!--            <label for="code"><?php echo get_phrase('video_title'); ?><span class="required">*</span></label>-->
                                                        <!--            <input type="text" name="video_title[]" id="video_title" class="form-control tab-4" value="" >-->
                                                        <!--        </div>-->
                                                        <!--        <div class="col-md-12">-->
                                                        <!--            <label for="code"><?php echo get_phrase('video_description'); ?><span class="required">*</span></label>-->
                                    ...
                                    <div class="tab-pane" id="preview">
                                        ...
                                        <!--    </div>-->
                                        <!--</div>-->
                                        <ul class="list-inline mt-3 wizard text-center">
                                            <li class="previous list-inline-item">
                                                <a href="javascript::" class="btn btn-info"> <i class="mdi mdi-arrow-left-bold"></i> </a>
                                            </li>
...
var blank_video = '<div>';
blank_video += '    <div class="row">';
blank_video += '    <div class="col-md-12">';
blank_video += '        <label for="code"><?php echo get_phrase('video_title'); ?><span class="required">*</span></label>';
blank_video += '        <input type="text" name="video_title[]" id="video_title" class="form-control tab-4" value="" >';
blank_video += '    </div>';
blank_video += '    <div class="col-md-12">';
blank_video += '        <label for="code"><?php echo get_phrase('video_description'); ?><span class="required">*</span></label>';
...
function calculateDiscountPercentage(discounted_price) {
    if (discounted_price > 0) {
        ...
        if (actualPrice > 0) {
            ...
            var discountedPercentage = ((actualPrice - reducedPrice) / actualPrice) * 100;
