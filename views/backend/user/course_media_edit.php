...
<div class="col-xl-10">
  <div class="form-group row mb-3">
    <label class="col-md-2 col-form-label" for="<?php echo $course_media; ?>_label"><?php echo get_phrase($course_media); ?><span class="required">*</span></label>
    <div class="col-md-10">
      <div class="wrapper-image-preview" style="margin-left: -6px;">
        <div class="box" style="width: 250px;">
          ...
          */
          ?>
          <div class="js--image-preview" style="background-image: url(<?= $course_details['thumbnail'];?>); background-color: #F5F5F5;"></div>
