	...
	<div class="col-md-12">
      ...
      <?php endif; ?>
			...
			<div class="form-group">
                ...
                <select class="form-control select2" data-toggle="select2" name="language_made_in" id="language_made_in" required>
            ...
            <div class="paid-course-stuffs">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="price_s" name = "price" placeholder="<?php echo get_phrase('enter_course_course_price'); ?>" min="0" required>
                </div>

                <div class="form-group">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" name="discount_flag" id="discount_flag_s" onclick="if($(this).prop('checked') == true){$('#discounted_price').prop('readonly',false);$('#discounted_price').attr('required',true);}else{$('#discounted_price').val('0');$('#discounted_price').prop('readonly',true);$('#discounted_price').prop('required',false);}" value="1">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="discounted_price" id="discounted_price" onkeyup="calculateDiscountPercentage(this.value)" required min="0" readonly>
