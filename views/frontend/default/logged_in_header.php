            ...
            <div class="col">
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <?php if (get_settings('allow_instructor') == 1) : ?>
                        ...
                        <div class="icon">
                        <a href="<?php echo site_url('home/banner_request'); ?>" class="btn btn-sign-in" style="border: 1px solid transparent; margin: 10px 10px; font-size: 14px; width: 100%; border-radius: 0;color:white;padding-top: 1px;">Banner
                            Request</a>
                      </div>
                    </div>
                    <div class="instructor-box menu-icon-box">
                    ...
                    <div class="user-box menu-icon-box">
                        ...
                        <div class="dropdown user-dropdown corner-triangle top-right">
                            <ul class="user-dropdown-menu">
                                        ...
                                        <div class="clearfix">
                                            ...
                                            <div class="user-details">
                                                <div class="user-name">
                                                    ...
                                                    <?php
                                                    $user_header_detail = $this->db->where('id', $this->session->userdata('user_id'))->get('users')->row_array();


                                                    echo $user_header_detail['first_name'] . ' ' . $user_header_detail['last_name']; ?>
                                                </div>
                                                <div class="user-email">
                                                    <span
                                                        class="email"><?php echo $user_header_detail['email']; ?></span>
                                                    <span
                                ...
                                <li class="user-dropdown-menu-item"><a
                                        href="<?php echo site_url('home/subscriptionHistory'); ?>"><i
                                            class="fas fa-rocket"></i>Subscription History</a></li>
                                <li class="user-dropdown-menu-item"><a
                    ...
                    <div class="sign-in-box btn-group d-none">
                        <a href="<?php echo site_url('home/banner_request'); ?>" class="btn btn-sign-in">Banner
                            Request</a>
