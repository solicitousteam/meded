...
<?php $social_links = json_decode($user_profile_details['social_links'], true);?>
            ...
            <div class="col">
                <div class="user-dashboard-box">
                    ...
                    <div class="user-dashboard-content">
                        ...
                        <form action="<?php echo site_url('home/update_profile/update_basics'); ?>" method="post" class="bg-white p-4">
                            <div class="content-box">
                                <div class="basic-group">
                             <div class="row"> 
                                  <div class="col-lg-12"><div class="form-group">
                                        <label for="FristName"><b></b><?php echo site_phrase('basics'); ?>:</b></label>
                                        </div></div>
                             <div class="col-lg-6"><div class="form-group">
                                        <input type="text" class="form-control" name = "first_name" id="FristName" placeholder="<?php echo site_phrase('first_name'); ?>" value="<?php echo $user_profile_details['first_name']; ?>">
                                        <small class="form-text text-muted"><?php echo site_phrase('First_Name'); ?>.</small>
                                    </div></div>
                                    <div class="col-lg-6"><div class="form-group">
                                        <input type="text" class="form-control" name = "last_name" placeholder="<?php echo site_phrase('last_name'); ?>" value="<?php echo $user_profile_details['last_name']; ?>">
                                        <small class="form-text text-muted"><?php echo site_phrase('Last Name'); ?>.</small>
                                    </div></div></div>
                           ...
                           <div class="row">    <div class="col-lg-12"> <div class="form-group">
                                        ...
                                        <textarea class="form-control author-biography-editor" name = "biography" id="Biography"><?php echo $user_profile_details['biography']; ?></textarea>
                                    </div></div></div>
                            </div>
