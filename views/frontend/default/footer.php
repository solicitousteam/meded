    ...
    <div class="row">
      <div class="col-md-6">
        <p class="copyright-text">
          <a href=""><img src="<?php echo base_url('uploads/system/'.get_frontend_settings('dark_logo')); ?>" alt="" class="d-inline-block" width="250"></a>
      ...
      <div class="col-md-6">
        <ul class="nav justify-content-md-end footer-menu">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo site_url('home/terms_and_condition'); ?>"><?php echo site_phrase('terms_and_conditions'); ?></a>
          </li>
          <!--<li class="nav-item">-->
