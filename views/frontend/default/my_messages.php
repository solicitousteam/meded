...
<?php
    ...
    $instructor_list = $this->db->select('id,first_name,last_name')->from('users')->where('role_id',1)->get()->result_array();
?>
<?php include "profile_menus.php"; ?>

<section class="message-area py-5">
  <div class="container">
    <div class="card">
      <div class="card-body">
                  ...
                  <div class="message-sender-wrap">
                    <div class="message-sender-head clearfix">
                      <div class="message-sender-info d-inline-block">
                        <div class="sender-image d-inline-block"> <img src="<?php echo $this->user_model->get_user_image_url($user_to_show_id);?>" alt="" class="img-fluid"> </div>
                      ...
                      <div class="message-time d-inline-block float-right"><?php echo date('D, d-M-Y H:i', $last_messages_details['timestamp']); ?></div>
                    </div>
                    <div class="message-sender-body"> <?php echo $last_messages_details['message']; ?> </div>
                  </div>
                </li>
                </a>
                <?php endforeach; ?>
            ...
            <div class="message-details-box" id = "toggle-2" style="display: none;">
              <div class="new-message-details">
                <div class="message-header">
                  <div class="sender-info"> <span class="d-inline-block"> <i class="far fa-user"></i> </span> <span class="d-inline-block"><?php echo site_phrase('new_message'); ?></span> </div>
                </div>
                <form class="" action="<?php echo site_url('home/my_messages/send_new?newmessage=1'); ?>" method="post">
                  <div class="message-body">
                    ...
                    <div class="form-group">
                      <textarea name="message" class="form-control message-input"></textarea>
                    </div>
...
/*15-04-2022 ajax message send*/

$('.send-message-btn').click(function() {
    var text = $(this).prev('.message-input').val();
    // console.log(text);
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('.message-content').html(json.Data);
            
            $('.message-input').val('');
            
            
            $('.message-content').css('overflow','overlay');
            
            var objDiv = document.querySelector(".message-content");
