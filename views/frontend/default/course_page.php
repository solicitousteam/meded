  ...
  <div class="container">
    <div class="row">
      ...
      <div class="what-you-get-box">
           <?php if($course_details['pain_point'] != "") {  ?> 
           
           
           <div class="what-you-get-title">Agenda</div>
          <ul class="what-you-get__items">
           
           
           <?php echo $course_details['pain_point']; ?>
    ...
    <div class="requirements-box">
         ...
         <?php if($course_details['cta'] != "") {  ?> 
           
           
             <div class="requirements-title">CTA</div>
      <div class="requirements-content">
        <ul class="requirements__list">
         <?php  echo $course_details['cta']; ?>
        </ul>
      </div>
      ...
      <?php  }  ?>
       ...
       <div class="requirements-box">
         ...
         <?php if($course_details['anything_else'] != "") {  ?> 
           
           
             <div class="requirements-title">Other benefits</div>
      <div class="requirements-content">
        <ul class="requirements__list">
         <?php  echo $course_details['anything_else']; ?>
        </ul>
      </div>
          ...
          <div class="course-comparism-item-container this-course">
            <div class="course-comparism-item clearfix">
              <div class="item-image float-left  mt-4 mt-md-0">
                <a href="<?php echo site_url('home/course/'.slugify($other_realted_course['title']).'/'.$other_realted_course['id']); ?>"><img src="<?= $course_details['thumbnails']; ?>" alt="" class="img-fluid"></a>
...
<div class="col-lg-4">
  <div class="course-sidebar natural new-course-price-block">
    <?php //if ($course_details['video_url'] != ""): ?>
      <div class="preview-video-box">
        <a data-toggle="modal" data-target="#CoursePreviewModal">
          <img src="<?= $course_details['thumbnail']; ?>" alt="" class="img-fluid">
    ...
    <div class="course-sidebar-text-box">
        <div class="row">
            ...
            {   
                if($course_details['discounted_price'] > 0)
                {
                    if($course_details['discounted_price'] == $course_details['price'])
                    {
                        $html .='<div>';
                        $html .='  <span>₹'.$course_details['discounted_price'].'</span>';
                        $html .='</div>';
                    }
                    else
                    {
                        $disc_per = $course_details['discounted_price'] * 100 / $course_details['price'];
                        
                        $discount_pre = round((100 - $disc_per),2).'% Off';
                        $html .='<div>';
                        $html .='  <span>₹'.$course_details['discounted_price'].'</span>';
                        $html .='</div>';
                        $html .='<div>';
                        $html .='  <label><strike>₹'.$course_details['price'].'</strike></label>';
                        $html .='</div>';
                        $html .='<div>';
                        $html .='  <label>'.$discount_pre.'</label>';
                        $html .='</div>';
                    }
                }
                else
                {
                    $html .='<div>';
                    $html .='  <span>₹'.$course_details['price'].'</span>';
                    $html .='</div>';
                }
            }
            $html .='</div>';
...
<?php if ($course_details['video_url'] != ""):
  ...
  if ($course_details['course_overview_provider'] == "html5") {
    ...
    $provider = $course_details['course_overview_provider'];
  }
  ?>
