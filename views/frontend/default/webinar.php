            ...
            <table id="basic-datatable" class="table table-striped table-centered mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $user->proposed_date?> <?php echo $user->proposed_time?></td>
                        <td>
                            <div class="dropright dropright">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="<?php echo site_url('user/webinar/edit_form/'.$user->id); ?>"><?php echo get_phrase('edit'); ?></a></li>
                                    ...
                                    <li><a class="dropdown-item" href="<?php echo site_url('user/webinar/delete/'.$user->id); ?>"><?php echo get_phrase('delete'); ?></a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
