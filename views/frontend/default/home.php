...
<section class="home-banner-area" style="background-image: url('<?= base_url("uploads/system/".get_frontend_settings('banner_image')); ?>');
 ...
 <video class="d-none" autoplay muted loop  width="100%" controls>
  <source src="uploads/system/meded_bag_promo_video.mp4" type="video/mp4">
  <source src="uploads/system/meded_bag_promo_video.mp4" type="video/ogg">
  Your browser does not support HTML5 video.
   ...
   <!--- <div class="container-lg">
        <h3>About Us</h3>
        <div class="row">
            <div class="col-lg-6">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</div>
                ...
                <div class="course-carousel shown-after-loading" style="display: none;">
                    ...
                    <div class="course-box-wrap">
                        <a href="<?php echo site_url('home/course/'.rawurlencode(slugify($latest_course['title'])).'/'.$latest_course['id']); ?>">
                            <div class="course-box">
                                <div class="course-image">
                                    <img src="<?php echo $this->crud_model->get_course_thumbnail_url($latest_course['id']); ?>" alt="" style="height: 200px; width: 100%; object-fit: cover">
                                </div>
                                <div class="course-details">
                                    <h5 class="title"><?php echo $latest_course['title']; ?> <?php  echo $latest_course['id']; ?></h5>
