                ...
                <div class="instructor-right-box">
                    ...
                    <div class="instructor-stat-box">
                        <ul>
                            <li>
                      <!--          <select>-->
                      <!--  <option>Total Student</option>-->
                      <!--  <option>aa</option>-->
                      <!--</select>-->
                                <h4><div class="strong"><?php echo site_phrase('total_student')." "."-"; ?>
<!--</div>-->
                            ...
                            <li>
                                <h4><div class="strong"><?php echo site_phrase('courses')." "."-"; ?>
                                <?php echo sizeof($course_ids); ?></div></h4>
                            </li>
                            <li>
                                <h4><div class="strong"><?php echo site_phrase('reviews')." "."-"; ?>
                                <?php echo $this->crud_model->get_instructor_wise_course_ratings($instructor_id, 'course')->num_rows(); ?></div></h4>
                            </li>
