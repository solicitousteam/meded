...
<section class="category-course-list-area">
    <div class="container pt-5">
        <form action="<?php echo site_url('login/register'); ?>" method="POST" enctype="multipart/form-data"
            name="form_220435892880462" id="220435892880462">
            <div class="form-v7-content register_form">
                <div class="form-left a1">
                    <div class="top_logo">
                        <img src="<?php echo base_url() ?>/assets/Logo-02w.png" width="150">
                    </div>
                ...
                <div class="form-detail mt-4" id="login1">
                    <div class="form-row ">
                        ...
                        <span class="help-block error">Please enter required field.</span>
                    </div>
                    <div class="form-row">
                        <label for="phone">MOBILE NUMBER*</label>
                        <input type="text" name="your_number" id="your_number"
                            oninput="$('#mobile_number').val(this.value);" class="input-text is-mobile" required
                            pattern="[789][0-9]{9}">
                        <span class="help-block error">Please enter required field.</span>
                    </div>
                    <div class="form-row">
                        ...
                        <input type="email" name="email" id="email" class="input-text"
                            oninput="$('#email_address').val(this.value);" required
                            pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,100}$">
                        <span class="help-block error">Please enter required field.</span>
                    </div>
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <input type="password" name="comfirm_password" id="comfirm_password" class="input-text"
                            required>
                        <span class="help-block error">Please enter required field.</span>
                        <i class="far fa-eye-slash" id="eye" style="margin-left: -30px; cursor: pointer;"></i>
                    </div>
                    <div class="form-row">
                        <input type="checkbox" class="input-text" name="term_and_condition" required
                            id="term_and_condition">
                        <label for="term_and_condition" style="cursor: pointer;">&nbsp; I accept the&nbsp; <a
                                href="<?php echo base_url() ?>home/terms_and_condition" target="_blank">terms and
                                conditions </a> and <a href="<?php echo base_url() ?>home/terms_and_condition">privacy
                                policy.</a></label>

                        <br>
                        <span class="help-block error" style="width: 100%;">Please enter required field.</span>`
                    </div>
                    <div class="form-row-last">
                        <input type="button" name="button" class="register" onclick="toggoleForm('instructor_form')"
                            value="Next">
                    </div>
                </div>
            </div>
            <div class="instructor_form" style="background: #fff;border-radius: 25px;display: none;">
                <div role="main">
                    ...
                    <link type="text/css" rel="stylesheet"
                        href="https://cdn02.jotfor.ms/css/styles/payment/payment_styles.css?3.3.30998" />
                    <link type="text/css" rel="stylesheet"
                        href="https://cdn03.jotfor.ms/css/styles/payment/payment_feature.css?3.3.30998" />
                    <ul class="form-section page-section">
                        <li id="cid_1" class="form-input-wide" data-type="control_head">
                            <div class="form-header-group  header-large"
                                style="background: #283392;border-radius: 29px;">
                            ...
                            <div id="cid_3" class="form-input-wide jf-required" data-layout="full">
                                <div data-wrapper-react="true">
                                    <span class="form-sub-label-container" style="vertical-align:top"
                                        ...
                                        <input type="text" id="first_3" name="q3_name[first]"
                                    ...
                                    <span class="form-sub-label-container" style="vertical-align:top"
                                        ...
                                        <input type="text" id="last_3" name="q3_name[last]"
                                            class="form-textbox validate[required]" data-defaultvalue=""
                                        ...
                                        <label class="form-sub-label" for="last_3" id="sublabel_3_last"
                                            style="min-height:13px" aria-hidden="false"> Last Name </label>
                                        <span class="help-block error">This field is required.</span>
                                    </span>
                                </div>
                            </div>
                        ...
                        <li class="form-line jf-required" data-type="control_address" id="id_34">
                            <label class="form-label form-label-top form-label-auto" id="label_34"
                                for="input_34_addr_line1">
                                Address
                                <span class="form-required">
                                    *
                                </span>
                                ...
                                <div summary="" class="form-address-table jsTest-addressField">
                                    <div class="form-address-line-wrapper jsTest-address-line-wrapperField">
                                        <span
                                            ...
                                            <span class="form-sub-label-container" style="vertical-align:top">
                                                <input type="text" id="input_34_addr_line1"
                                                    name="q34_address[addr_line1]"
                                                    class="form-textbox form-address-line" data-defaultvalue=""
                                                    autocomplete="section-input_34 address-line1" value=""
                                                    data-component="address_line_1"
                                                    aria-labelledby="label_34 sublabel_34_addr_line1">
                                                <label class="form-sub-label" for="input_34_addr_line1"
                                                    id="sublabel_34_addr_line1" style="min-height:13px"
                                    ...
                                    <div class="form-address-line-wrapper jsTest-address-line-wrapperField">
                                        <span
                                            class="form-address-line form-address-street-line jsTest-address-lineField">
                                            <span class="form-sub-label-container" style="vertical-align:top">
                                                <input type="text" id="input_34_addr_line2"
                                                    name="q34_address[addr_line2]"
                                                    class="form-textbox form-address-line" data-defaultvalue=""
                                                    autocomplete="section-input_34 address-line2" value=""
                                                    data-component="address_line_2"
                                                    aria-labelledby="label_34 sublabel_34_addr_line2">
                                                <label class="form-sub-label" for="input_34_addr_line2"
                                                    id="sublabel_34_addr_line2" style="min-height:13px"
                                    ...
                                    <div class="form-address-line-wrapper jsTest-address-line-wrapperField">
                                        <span
                                            ...
                                            <span class="form-sub-label-container" style="vertical-align:top">
                                                <input type="text" id="input_34_city" name="city"
                                                    class="form-textbox validate[required] form-address-city"
                                                    data-defaultvalue="" autocomplete="section-input_34 address-level2"
                                                    value="" data-component="city"
                                                    aria-labelledby="label_34 sublabel_34_city" required="">
                                                <label class="form-sub-label" for="input_34_city" id="sublabel_34_city"
                                                    style="min-height:13px" aria-hidden="false"> City <span class="form-required">*</span> </label>
                                                <span class="input_34_city-error help-block error">This field is required.</span>
                                            </span>
                                        </span>
                                        <span
                                            class="form-address-line form-address-state-line jsTest-address-lineField ">
                                            <span class="form-sub-label-container" style="vertical-align:top">
                                                <input type="text" id="input_34_state" name="state"
                                                    class="form-textbox validate[required] form-address-state"
                                                    data-defaultvalue="" autocomplete="section-input_34 address-level1"
                                                    value="" data-component="state"
                                                    aria-labelledby="label_34 sublabel_34_state" required="">
                                                <label class="form-sub-label" for="input_34_state"
                                                    id="sublabel_34_state" style="min-height:13px" aria-hidden="false">
                                                    State / Province<span class="form-required">*</span>  </label>
                                                <span class="input_34_state-error help-block error">This field is required.</span>
                                            </span>
                                        </span>
                                        <span class="form-address-line form-address-zip-line jsTest-address-lineField ">
                                            <span class="form-sub-label-container" style="vertical-align:top">
                                                <input type="text" id="input_34_postal" name="postal"
                                                    class="form-textbox validate[required] form-address-postal"
                                                    data-defaultvalue="" autocomplete="section-input_34 postal-code"
                                                    value="" data-component="zip"
                                                    aria-labelledby="label_34 sublabel_34_postal" required="">
                                                <label class="form-sub-label" for="input_34_postal"
                                                    id="sublabel_34_postal" style="min-height:13px" aria-hidden="false">
                                                    Postal / Zip Code<span class="form-required">*</span> </label>
                                                <span class="input_34_pincode-error help-block error">This field is required.</span>
                                            </span>
                                        </span>
                                    </div>
                                    <div class="form-address-line-wrapper jsTest-address-line-wrapperField">
                                        <span class="form-address-line form-address-zip-line jsTest-address-lineField ">
                                            <span class="form-sub-label-container" style="vertical-align:top">
                                                <input type="text" id="mobile_number" name="mobile_number" required
                                                    class="form-textbox validate[required] is-mobile" data-defaultvalue=""
                                                    autocomplete="" value="" data-component="" aria-labelledby=""
                                                    required="">
                                                <label class="form-sub-label mobile_number-error  error"
                                                    style="min-height:13px" aria-hidden="false"> Phone Number<span
                                                        class="form-required">
                                                        *
                                                    </span> </label>
                                                <span class="help-block error">This field is required.</span>
                                        ...
                                        <span class="form-address-line form-address-zip-line jsTest-address-lineField ">
                                            <span class="form-sub-label-container" style="vertical-align:top">
                                                <input type="text" id="email_address" name="email_address" required
                                                    class="form-textbox validate[required]" data-defaultvalue=""
                                                    autocomplete="" aria-labelledby="" required="">
                                                <label class="form-sub-label email_address-error  error"
                                                    style="min-height:13px" aria-hidden="false">Email Address<span
                                                        class="form-required">
                                                        *
                                                    </span> </label>
                                                <span class="help-block error">This field is required.</span>
                   ...
                   <label class="form-sub-label" for="input_5" id="sublabel_input_5" style="min-height:13px" aria-hidden="false"> example@example.com </label>
                        ...
                        <li class="form-line form-line-column form-col-3 jf-required" data-type="control_datetime"
                            ...
                            <input type="date" name="birth_date" class="form-control" id="birth_date"
                                max="<?= date('Y-m-d', strtotime('- 18 Years')); ?>" min='1899-01-01'>
                            <span class="help-block error">This field is required.</span>
                            </span>
                        </li>
                        <li class="form-line jf-required" data-type="control_fileupload" id="id_10">
                            ...
                            <span class="help-block error">Please select file.</span>
                        </li>
                        <li class="form-line jf-required" data-type="control_fileupload" id="id_49">
                            ...
                            <input type="file" name="file1" id="file1" class="dropify" accept=
"application/*, image/*">
                            <span class="help-block error">Please select file.</span>
                        </li>
                        ...
                        <li class="form-line" data-type="control_phone" id="id_39">
                            <label class="form-label form-label-top form-label-auto" id="label_39" for="input_39_full">
                                Primary Emergency | Phone Number <span class="form-required">
                                    *
                                </span></label>
                            <div id="cid_39" class="form-input-wide" data-layout="half">
                                <span class="form-sub-label-container" style="vertical-align:top">
                                    <input type="text" id="emergency_mobile" name="emergency_mobile"
                                        ...
                                        autocomplete="section-input_39 tel-national" style="width:310px"
                                        data-masked="true" value="" placeholder="(000) 000-0000" data-component="phone"
                                        aria-labelledby="label_39 sublabel_39_masked" inputmode="text"
                                        maskvalue="(###) ###-####">
                                    <span class="emergency_mobile-error error"></span>
                                </span>
                            </div>
                        </li>
                        <li class="form-line" data-type="control_textbox" id="id_41">
                            <label class="form-label form-label-top form-label-auto" id="label_41" for="input_41">
                                Primary Emergency | What is your relationship with this person?<span class="form-required">*</span>  </label>
                            <div id="cid_41" class="form-input-wide" data-layout="half">
                                <input type="text" id="input_41" name="q41_primaryEmergency41" data-type="input-textbox"
                                    class="form-textbox" data-defaultvalue="" style="width:310px" size="310" value=""
                                    data-component="textbox" aria-labelledby="label_41">
                            </div>
                        </li>
                        <li class="form-line" data-type="control_fullname" id="id_38">
                            <label class="form-label form-label-top form-label-auto" id="label_38" for="first_38">
                                Primary Emergency | Contact Name <span class="form-required">*</span> </label>
                            <div id="cid_38" class="form-input-wide" data-layout="full">
                                <div data-wrapper-react="true">
                                    <span class="form-sub-label-container" style="vertical-align:top"
                                        data-input-type="first">
                                        <input type="text" id="first_38" name="q38_primaryEmergency38[first]"
                                            class="form-textbox" data-defaultvalue=""
                                            autocomplete="section-input_38 given-name" size="10" value=""
                                            data-component="first" aria-labelledby="label_38 sublabel_38_first">
                                        <label class="form-sub-label" for="first_38" id="sublabel_38_first"
                                            style="min-height:13px" aria-hidden="false"> First Name </label>
                                    </span>
                                    <span class="form-sub-label-container" style="vertical-align:top"
                                        data-input-type="last">
                                        <input type="text" id="last_38" name="q38_primaryEmergency38[last]"
                                            class="form-textbox" data-defaultvalue=""
                                            autocomplete="section-input_38 family-name" size="15" value=""
                                            data-component="last" aria-labelledby="label_38 sublabel_38_last">
                                        <label class="form-sub-label" for="last_38" id="sublabel_38_last"
                                            style="min-height:13px" aria-hidden="false"> Last Name </label>
                                    </span>
                                </div>
                            </div>
                        ...
                        <li class="form-line jf-required" data-type="control_textbox" id="id_13">
                            ...
                            <div id="cid_13" class="form-input-wide jf-required" data-layout="half">
                                <input type="text" id="input_13" name="q13_profession" data-type="input-textbox"
                                    class="form-textbox validate[required]" data-defaultvalue="" style="width:310px"
                                    size="310" value="" data-component="textbox" aria-labelledby="label_13" required="">
                                <span class="help-block error">This field is required.</span>
                                </span>
                            </div>
                        </li>
                        <li class="form-line jf-required" data-type="control_textbox" id="id_59">
                            ...
                            <div id="cid_59" class="form-input-wide jf-required" data-layout="half">
                                <input type="text" id="input_59" name="q59_whatIs" data-type="input-textbox"
                                    class="form-textbox validate[required]" data-defaultvalue="" style="width:310px"
                                    size="310" value="" data-component="textbox" aria-labelledby="label_59" required="">
                                <span class="help-block error">This field is required.</span>
                                </span>
                            </div>
                        </li>
                        <li class="form-line jf-required" data-type="control_dropdown" id="id_12">
                            ...
                            <div id="cid_12" class="form-input-wide jf-required" data-layout="half">
                                <input type="text" id="specialisation" name="specialisation" data-type="input-textbox"
                                    class="form-textbox validate[required]" data-defaultvalue="" style="width:310px"
                                    size="310" value="" data-component="textbox" aria-labelledby="label_59" required="">
                                <span class="help-block error">This field is required.</span>
                                </span>
                        ...
                        <li class="form-line jf-required" data-type="control_textbox" id="id_60">
                            ...
                            <div id="cid_60" class="form-input-wide jf-required" data-layout="half">
                                <input type="text" id="input_60" name="q60_whichOrganisation" data-type="input-textbox"
                                    class="form-textbox validate[required]" data-defaultvalue="" style="width:310px"
                                    size="310" value="" data-component="textbox" aria-labelledby="label_60" required="">
                                <span class="help-block error">This field is required.</span>
                                </span>
                            </div>
                        </li>
                        <li class="form-line jf-required" data-type="control_textbox">
                            ...
                            <div class="form-input-wide jf-required" data-layout="half">
                                <input type="text" id="organisation_email" name="organisation_email"
                                    data-type="input-textbox" class="form-textbox validate[required]"
                                    data-defaultvalue="" style="width:310px" size="310" value=""
                                    data-component="textbox" aria-labelledby="label_60" required="">
                                <span class="organisation_email-error error"></span>
                            </div>
                        </li>
                        <li class="form-line jf-required" data-type="control_dropdown" id="id_11">
                            ...
                            <div id="cid_11" class="form-input-wide jf-required" data-layout="half">
                                <select class="form-dropdown validate[required]" id="input_11" name="q11_workingPattern"
                        ...
                        <li class="form-line jf-required" data-type="control_radio" id="id_54">
                            ...
                            <div id="cid_54" class="form-input-wide jf-required" data-layout="full">
                                <div class="form-single-column" role="group" aria-labelledby="label_54"
                                    data-component="radio">
                                    <span class="form-radio-item" style="clear:left">
                                        <span class="dragger-item">
                                        </span>
                                        <input type="radio" aria-describedby="label_54"
                                            class="form-radio validate[required] input_54_1" id="input_54_0"
                                            name="q54_haveYou" value="YES" required="" checked="">
                                    ...
                                    <span class="form-radio-item" style="clear:left">
                                        ...
                                        <input type="radio" aria-describedby="label_54"
                                            class="input_54_1 form-radio validate[required]" id="input_54_1"
                                            name="q54_haveYou" value="NO" required="">
                        ...
                        <li class="form-line jf-required" data-type="control_checkbox" id="id_56">
                            ...
                            <div id="cid_56" class="form-input-wide jf-required" data-layout="full">
                                <div class="form-single-column" role="group" aria-labelledby="label_56"
                                    data-component="radio">
                                    <span class="form-radio-item" style="clear:left">
                                        <span class="dragger-item">
                                        </span>

                                        <input type="radio" aria-describedby="label_56"
                                            onchange="if(this.value == 'YES'){$('#input_58').attr('min','1');$('#input_58').val(1);}else{$('#input_58').attr('min','0');$('#input_58').val('0');}"
                                            class="form-radio validate[required] input_56_0" id="input_56_0"
                                            name="q56_name56" value="YES">
                                    ...
                                    <span class="form-radio-item" style="clear:left">
                                        ...
                                        <input type="radio" aria-describedby="label_56"
                                            onchange="if(this.value == 'YES'){$('#input_58').attr('min','1');$('#input_58').val(1);}else{$('#input_58').attr('min','0');$('#input_58').val('0');}"
                                            class="form-radio validate[required] input_56_0" id="input_56_1"
                                            name="q56_name56" value="NO">
                        ...
                        <li class="form-line jf-required" data-type="control_number" id="id_58">
                            ...
                            <div id="cid_58" class="form-input-wide jf-required" data-layout="half">
                                <input type="number" id="input_58" name="q58_ifYes" data-type="input-number"
                                    class=" form-number-input form-textbox validate[required]" data-defaultvalue="0"
                                    style="width:310px" size="310" value="0" placeholder="ex: 23"
                                    data-component="number" aria-labelledby="label_58" required="" step="any">
                                <!-- onblur="checkval(this.value)" -->
                                <span class="help-block error">This field is required.</span>
                                </span>
                            </div>
                        </li>
                        ...
                        <li class="form-line jf-required" data-type="control_fileupload">
                            <label class="form-label form-label-top form-label-auto">
                                Upload Documents (License certificate/ Degree certificate/ Experience certificate)
                                <span class="form-required">
                                    *
                                </span>
                            </label>
                            <input type="file" name="document_file" id="document_file" class="dropify" accept=
"application/*, image/*">
                            <span class="help-block error">Please select file.</span>
                        </li>
                        ...
                        <li class="form-line jf-required" data-type="control_fileupload">
                            ...
                            <input type="file" name="other_supporting_file" id="other_supporting_file" class="dropify" accept=
"application/*, image/*">
                            <span class="help-block error">Please select file.</span>
                        </li>

                        <li class="form-line jf-required" data-type="control_number" id="id_58">
                            <input type="button" name="button" class="register" onclick="form_submit1()"
                                id="form_submit" value="Register" style="padding: 15px;">
                        </li>
                    </ul>
...
function checkRequiredFields1() {
    ...
    var city = $('#input_34_city').val();
    var state = $('#input_34_state').val();
    var postal = $('#input_34_postal').val();
    
    var birth_date = $('#birth_date').val();
    var file = $('#file').val();
    var file1 = $('#file1').val();
    var document_file = $('#document_file').val();
    var other_supporting_file = $('#other_supporting_file').val();
    ...
    if (first_name == '') {
        ...
        setTimeout(function() {
            $('#first_3').closest('.form-sub-label-container').find('.help-block').hide()
        }, 9000);
    }
    if (city == '') {
        fail = false;
        $('.input_34_city-error').show();
        setTimeout(function() {
            $('.input_34_city-error').hide()
        }, 9000);
    }
    if (state == '') {
        fail = false;
        $('.input_34_state-error').show();
        setTimeout(function() {
            $('.input_34_state-error').hide()
        }, 9000);
    }
    if (postal == '') {
        fail = false;
        $('.input_34_postal-error').closest('.form-line').find('.help-block').show();
        setTimeout(function() {
            $('.input_34_postal-error').hide()
        }, 9000);
    }
    if (profession == '') {
        fail = false;
        ...
        setTimeout(function() {
            $('#input_13').closest('.form-line').find('.help-block').hide()
        }, 9000);
    }
    if (qualification == '') {
        fail = false;
        ...
        setTimeout(function() {
            $('#input_59').closest('.form-line').find('.help-block').hide()
        }, 9000);
    }
    // if(plat_form == ''){
    //   fail = false;
    ...
    if (teaching_experience_count == 0) {
        ...
        setTimeout(function() {
            $('.input_56_0').closest('.form-line').find('.help-block').hide()
        }, 9000);
    }
    if (whichOrganisation == '') {
        ...
        setTimeout(function() {
            $('#input_60').closest('.form-line').find('.help-block').hide()
        }, 9000);
    }
    if (input_58 == '') {
        fail = false;
        ...
        setTimeout(function() {
            $('#input_58').closest('.form-line').find('.help-block').hide()
        }, 9000);
    }
    if (working_pattern == '') {
        fail = false;
        ...
        setTimeout(function() {
            $('#input_11').closest('.form-line').find('.help-block').hide()
        }, 9000);
    }
    if (specialisation == '') {
        fail = false;
        ...
        setTimeout(function() {
            $('#specialisation').closest('.form-line').find('.help-block').hide()
        }, 9000);
    }
    $('.mobile_number-error').html('');
    if (mobile_number == '') {
        fail = false;
        $('.mobile_number-error').html('This field is required');
        setTimeout(function() {
            $('.mobile_number-error').html('')
        }, 9000);
    }
    ...
    if (email_address == '') {
        fail = false;
        $('.email_address-error').html('This field is required');
        setTimeout(function() {
    ...
    if (emergency_mobile == '') {
        fail = false;
        $('.emergency_mobile-error').html('This field is required');
        setTimeout(function() {
            $('.emergency_mobile-error').html('')
        }, 9000);
    }

    if (organisation_email == '') {
        fail = false;
        $('.organisation_email-error').html('This field is required');
        setTimeout(function() {
            $('.organisation_email-error').html('')
        }, 9000);
    }
    ...
    if (file == '') {
        ...
        setTimeout(function() {
            $('#file').closest('.form-line').find('.help-block').hide()
        }, 9000);
    }
    if (file1 == '') {
        // console.log(file1);
        fail = false;
        //   alert($('#file1').closest('.form-line').find('.help-block').html());
        $('#file1').closest('.form-line').find('.help-block').show();
        setTimeout(function() {
            $('#file1').closest('.form-line').find('.help-block').hide()
        }, 9000);
    }

    if (document_file == '') {
        fail = false;
        $('#document_file').closest('.form-line').find('.help-block').show();
        setTimeout(function() {
            $('#document_file').closest('.form-line').find('.help-block').hide()
        }, 9000);
    }
    if (other_supporting_file == '') {
        // console.log(file1);
        fail = false;
        //   alert($('#other_supporting_file').closest('.form-line').find('.help-block').html());
        $('#other_supporting_file').closest('.form-line').find('.help-block').show();
        setTimeout(function() {
            $('#other_supporting_file').closest('.form-line').find('.help-block').hide()
        }, 9000);
    }
    ...
    if (birth_date == '') {
        ...
        setTimeout(function() {
            $('#birth_date').closest('.form-line').find('.help-block').hide()
        }, 9000);
    }
    if (last_name == '') {
        fail = false;
        ...
        setTimeout(function() {
            $('#last_3').closest('.form-sub-label-container').find('.help-block').hide()
        }, 9000);
    }
    if (address == '') {
        fail = false;
        ...
        setTimeout(function() {
            $('#input_34_addr_line1').closest('.form-sub-label-container').find('.help-block').hide()
        }, 9000);
    }
    var email_address = '';
    if ($()) {
...
function checkRequiredFields() {
    ...
    if ($('#username').val() == '') {
        ...
        $('#username').closest('.form-row').find('.help-block').html('Please enter required field');
        setTimeout(function() {
            $('#username').closest('.form-row').find('.help-block').hide()
        }, 4000);
    }
    ...
    if ($('#your_number').val() == '') {
        ...
        setTimeout(function() {
            $('#your_number').closest('.form-row').find('.help-block').hide()
        }, 4000);
        fail = false;
    }
    if (password == '') {
        ...
        setTimeout(function() {
            $('#password').closest('.form-row').find('.help-block').hide()
        }, 4000);
        fail = false;
    }
    if ($('#comfirm_password').val() == '') {
        ...
        setTimeout(function() {
            $('#comfirm_password').closest('.form-row').find('.help-block').hide()
        }, 4000);
        fail = false;
    }
    if ($('#term_and_condition').prop('checked') == false) {
        ...
        setTimeout(function() {
            $('#term_and_condition').closest('.form-row').find('.help-block').hide()
        }, 4000);
        fail = false;
    }
    ...
    if (comfirm_password != '') {
        if (password != comfirm_password) {
            $('#comfirm_password').closest('.form-row').find('.help-block').show();
            $('#comfirm_password').closest('.form-row').find('.help-block').html(
    ...
    if ($('#email').val() == '') {
        ...
        setTimeout(function() {
            $('#email').closest('.form-row').find('.help-block').hide()
        }, 4000);
        fail = false;
    }
    if ($('#your_number').val() != '') {
...
function checkval(exp) {
    var type = $('input[name=q56_name56]').val();
    // alert(type);return false

    if (type.toLowerCase() == 'no') {
        $('#input_58').val('0');
    } else {
        var oldvalue = $('#input_58').val('0');
        if (parseInt(oldvalue) <= 0) {
            $('#input_58').val('1');
        } else {
            $('#input_58').val(oldvalue);
        }
    }


    // if(($('input[name=q56_name56]').val() == 'YES') && this.value <= 1)
    // {$(this).val(1);}else if($('input[name=q56_name56]').val() == 'NO'){alert('no');$(this).val('0');}else{$(this).val('0');}
}

$(".is-mobile").keypress(function() {
    var val = $(this).val();
    if(val.length>9)
        return false;
    else
...
<script>
 const passwordField = document.querySelector("#comfirm_password");
